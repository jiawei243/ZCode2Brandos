...
const buildResult = await build({
  ...
  bundle: true,
  outfile: "dist/remote/wbrand-server.cjs",
  platform: "node",
  format: "cjs",
  target: "node22",
...
const remoteBundleSource = readFileSync("dist/remote/wbrand-server.cjs", "utf-8");
...
console.log("Built dist/remote/wbrand-server.cjs");
