...
import type { WBrandAgentMcpServer } from "@wbrand/shared";
...
function isFilesystemServer(
  server: WBrandAgentMcpServer,
): server is Extract<WBrandAgentMcpServer, { command: string }> {
  return (
    "command" in server &&
...
export function appendWorkspaceToFilesystemMcpServers(
  mcpServers: WBrandAgentMcpServer[] | undefined,
  workspacePath: string,
): WBrandAgentMcpServer[] | undefined {
