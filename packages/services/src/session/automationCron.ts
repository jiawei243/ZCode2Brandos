...
import type { WBrandAutomation, WBrandAutomationScheduleRule } from "@wbrand/shared";
...
export function scheduleRuleDefinition(rule: WBrandAutomationScheduleRule): string {
...
export function isOneShotAutomation(
  automation: Pick<WBrandAutomation, "recurring" | "maxRuns">,
): boolean {
...
export function buildRelativeDelaySchedule(
  delayMinutes: number,
  from = Date.now(),
): Pick<WBrandAutomation, "cronExpr" | "scheduleRule"> {
...
export function computeInitialAutomationNextRunAt(
  automation: Pick<WBrandAutomation, "cronExpr" | "recurring" | "scheduleRule">,
  from = Date.now(),
): number | null {
...
export function computeScheduleRuleNextRunAt(
  rule: WBrandAutomationScheduleRule,
  from = Date.now(),
): number | null {
...
export function inferMinuteIntervalScheduleRule(
  cronExpr: string,
  anchorAt: number,
): WBrandAutomationScheduleRule | undefined {
...
export function buildIntervalScheduleRule(
  intervalUnit: WBrandAutomationScheduleRule["unit"],
  interval: number,
  cronExpr: string,
  anchorAt: number,
...
export function computeAutomationNextRunAt(
  automation: Pick<WBrandAutomation, "cronExpr" | "scheduleRule">,
  from?: number,
): number | null {
