import type { Hook, WBrandWorkspaceHookTrustGrantResult } from "@wbrand/shared";
import type { WorkspaceHookBundleSnapshotData } from "@wbrand/shared/workspace-hook-discovery";
