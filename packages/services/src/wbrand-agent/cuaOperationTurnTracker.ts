import { resolveWorkspaceKey, type WBrandComputerUseOperationEvent } from "@wbrand/shared";
...
interface CuaOperationTurnTracker {
  accept(workspace: CuaOperationWorkspaceTarget, event: WBrandComputerUseOperationEvent): void;
...
export function createCuaOperationTurnTracker(options: {
  ...
  function accept(
    workspace: CuaOperationWorkspaceTarget,
    event: WBrandComputerUseOperationEvent,
  ): void {
