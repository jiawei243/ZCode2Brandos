import { wbrandProtocolMethods, wbrandRuntimeCapabilitiesSchema } from "@wbrand/shared";
import type { WBrandProtocolClient } from "./wbrandProtocolClient.js";
...
export function ensureIndependentPlanSupport(
  ...
  const check = client
    .request(wbrandProtocolMethods.runtimeCapabilities, {}, wbrandRuntimeCapabilitiesSchema)
    .then((result) => {
