...
export class WBrandStorageStartupGate {
  private current?: WBrandStorageStartupState;
  private terminalError?: Error;
  private pending?: Promise<void>;
  private resolve?: () => void;
  private reject?: (error: Error) => void;
  private timer?: ReturnType<typeof setTimeout>;
  private readonly changed = new Emitter<WBrandStorageStartupState>();
  ...
  get snapshot(): WBrandStorageStartupState | undefined {
    return this.current;
  }

  accept(input: unknown): boolean {
    const parsed = wbrandStorageStartupStateSchema.safeParse(input);
