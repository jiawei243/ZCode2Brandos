import { requestPluginReferenceCatalog } from "#src/wbrand-agent/pluginReferenceCatalogRequest.js";
import {
  localTtftFactsSchema,
  sessionDebugSnapshotSchema,
  type LocalTtftFacts,
} from "@wbrand/shared";
/* oxlint-disable eslint(max-lines) -- WBrand Protocol transport、通知 wiring 和 app-facing session 方法必须共享同一个 client/emitter 上下文。 */
import { randomUUID } from "node:crypto";
import { ensureIndependentPlanSupport } from "./independentPlanSupport.js";
import { mkdirSync } from "node:fs";
import { join } from "node:path";
import { Emitter } from "@wbrand/rpc";
...
import { completeNewModelSelection } from "@wbrand/provider";
import type { OffPeakClientConfig } from "#src/coding-plan-subscription/codingPlanSubscription.js";
import {
  WBRAND_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
  formatLogPrefix,
  resolveWorkspaceKey,
  type TraceId,
  WBRAND_AGENT_PROVIDER,
  WBRAND_AGENT_PROVIDER_NOT_READY_CODE,
  WBRAND_AGENT_PROVIDER_NOT_READY_REASON,
  WBRAND_MODEL_REASONING_SEPARATOR,
  isRemoteWorkspaceIdentity,
  WBRAND_PROTOCOL_NAME,
  WBRAND_PROTOCOL_VERSION,
  wbrandMcpListResultSchema,
  wbrandPermissionRequestParamsSchema,
  wbrandBrowserListParamsSchema,
  wbrandBrowserExecuteParamsSchema,
  wbrandPluginsConfigureResultSchema,
  wbrandPluginsInstallResultSchema,
  wbrandPluginsListResultSchema,
  wbrandPluginsMarketplaceMutationResultSchema,
  wbrandPluginsOverviewResultSchema,
  wbrandProcessChildProcessesResultSchema,
  type WBrandProcessChildProcess,
  wbrandSkillsReferenceCatalogResultSchema,
  wbrandWorkflowsDeleteResultSchema,
  wbrandWorkflowsGetResultSchema,
  wbrandWorkflowsListResultSchema,
  wbrandWorkflowsMoveResultSchema,
  wbrandWorkflowsRunsResultSchema,
  wbrandWorkflowsUpdateMetaResultSchema,
  wbrandPluginsResolveSuggestedReferenceResultSchema,
  wbrandPluginOperationProgressNotificationSchema,
  wbrandPluginsRestoreBuiltinResultSchema,
  wbrandPluginsSetEnabledResultSchema,
  wbrandPluginsCancelOperationResultSchema,
  wbrandPluginsUninstallResultSchema,
  wbrandPluginsValidateResultSchema,
  wbrandPluginsDescribeResultSchema,
  wbrandAutomationCheckTaskBindingParamsSchema,
  wbrandAutomationCreateParamsSchema,
  wbrandAutomationDeleteParamsSchema,
  wbrandAutomationListParamsSchema,
  wbrandAutomationUpdateParamsSchema,
  wbrandOffPeakCreateParamsSchema,
  wbrandOffPeakListParamsSchema,
  OFF_PEAK_PROVIDER_IDS,
  wbrandComputerUseOperationEventSchema,
  wbrandProviderRuntimeHeadersCancelledSchema,
  wbrandProviderRuntimeHeadersRequestParamsSchema,
  wbrandProviderTestModelConnectivityResultSchema,
  wbrandOfficialMcpAuthHeadersRequestParamsSchema,
  summarizeOfficialMcpIdentityHeaders,
  wbrandProtocolEmptyResultSchema,
  wbrandProtocolMethods,
  wbrandProtocolNotifications,
  wbrandMcpTelemetryEventSchema,
  wbrandMcpResourceSamplesSchema,
  wbrandToolExecResourceSchema,
  wbrandProcessResourceSampleSchema,
  wbrandSessionCloseResultSchema,
  wbrandSessionCompactResultSchema,
  wbrandSessionEventsResultSchema,
  wbrandSessionGoalResultSchema,
  wbrandSessionListResultSchema,
  wbrandSessionSubagentsResultSchema,
  wbrandSessionMessagesResultSchema,
  wbrandSessionEventSchema,
  wbrandSessionSendResultSchema,
  wbrandSessionRequestRuntimePreferencesParamsSchema,
  wbrandSessionRuntimePreferencesResultSchema,
  wbrandSessionStateSnapshotSchema,
  wbrandSessionSubscribeResultSchema,
  wbrandStateUpdatedNotificationSchema,
  wbrandUserInputRequestParamsSchema,
  wbrandWorkspacePresentationSchema,
  wbrandWorkspaceCancelGenerateTextResultSchema,
  wbrandWorkspaceGenerateTextResultSchema,
  wbrandWorkspaceHookTrustGrantResultSchema,
  wbrandWorkspaceUpdateInteractionPreferencesResultSchema,
  wbrandWorkspaceUpdateModelIoPreferencesResultSchema,
  wbrandProviderUpdateAccountConfigResultSchema,
  type WBrandSessionStateSnapshot,
  type WBrandAutomation,
  type WBrandAutomationRun,
  wbrandWorkspaceUpdateOffPeakToolPolicyResultSchema,
  wbrandWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
  ...
  type WBrandToolExecResource,
  type WBrandPluginOperationProgressNotification,
  type WBrandTaskMode,
} from "@wbrand/shared";
...
} from "#src/wbrand-agent/automationToolPolicy.js";
import { WBRAND_AGENT_RUNTIME_UNAVAILABLE_CODE } from "./wbrandAgent.js";
import type {
  WBrandProtocolRequestId,
  ModelSelection,
  WBrandProviderRuntimeHeadersRequestParams,
  WBrandSessionEvent,
  WBrandSessionRuntimePreferencesScope,
  WBrandSavedWorkflowScope,
...
import type {
  IWBrandAgentService,
  WBrandAgentBackgroundBashOutputParams,
  WBrandAgentAppRuntimePreferences,
  WBrandAgentRuntimeLifecycleEvent,
  WBrandAgentAddPluginMarketplaceParams,
  WBrandAgentAppUsageParams,
  WBrandAgentCancelPluginOperationParams,
  WBrandAgentCompactParams,
  WBrandAgentConfigurePluginParams,
  WBrandAgentResetPluginConfigParams,
  WBrandAgentCreateSessionParams,
  WBrandAgentInstallPluginParams,
  WBrandAgentGenerateWorkspaceTextParams,
  WBrandAgentTestModelConnectivityParams,
  WBrandAgentGoalParams,
  WBrandAgentGrantWorkspaceHookTrustParams,
  WBrandAgentInitializeResult,
  WBrandAgentListSessionsParams,
  WBrandAgentListSessionSubagentsParams,
  WBrandAgentReadWorkspacePresentationParams,
  WBrandAgentReadSessionEventsParams,
  WBrandAgentReadSessionMessagesParams,
  WBrandAgentReadSessionParams,
  WBrandAgentRemovePluginMarketplaceParams,
  WBrandAgentRespondSessionRuntimePreferencesParams,
  WBrandAgentResumeSessionParams,
  WBrandAgentSendPromptParams,
  WBrandAgentServiceEvent,
  WBrandAgentSessionSubscribeParams,
  WBrandAgentSessionTarget,
  WBrandAgentSessionRuntimePreferencesRequest,
  WBrandAgentTaskTokenUsageParams,
  WBrandAgentSetModeParams,
  WBrandAgentSetModelParams,
  WBrandAgentSetPluginEnabledParams,
  WBrandAgentSetThoughtLevelParams,
  ...
  WBrandAgentSavedWorkflowTarget,
  ...
  WBrandAgentCuaPermissionObservation,
  ...
  WBrandAgentAttachmentBeginParams,
  WBrandAgentAttachmentChunkParams,
  WBrandAgentAttachmentReadParams,
  WBrandAgentConversationAttachmentReadParams,
  WBrandAgentConversationAttachmentStatParams,
  WBrandAgentAttachmentPreviewSourceParams,
  WBrandAgentAttachmentTerminalParams,
  WBrandAgentConversationCommandParams,
  WBrandAgentCommandsQueryParams,
  WBrandAgentConversationFileChangesParams,
  WBrandAgentConversationFileRewindPreviewParams,
  WBrandAgentConversationRowsRangeParams,
  WBrandAgentConversationPlansParams,
  WBrandAgentConversationWorkflowRunEventsParams,
  WBrandAgentConversationWorkflowRunArtifactDataParams,
  WBrandAgentConversationWorkflowRunArtifactReadParams,
  WBrandAgentConversationWorkflowRunArtifactsParams,
  WBrandAgentConversationWorkflowRunNodeResultParams,
  WBrandAgentConversationWorkflowRunWorkspaceParams,
  WBrandAgentConversationWorkflowRunsParams,
  WBrandAgentConversationResyncParams,
  WBrandAgentConversationSubscribeParams,
  WBrandAgentConversationUnsubscribeParams,
  WBrandAgentConnectionFlowParams,
  WBrandAgentSessionsIndexSubscribeParams,
  WBrandAgentWorkspaceConfigSubscribeParams,
} from "./wbrandAgent.js";
import {
  ...
  utf8JsonByteLength,
  WBRAND_ATTACHMENT_FAULT_CODES,
  WBrandAttachmentFaultError,
  type CommandAck,
...
import {
  readTrustedWBrandAgentV4Connection,
  readTrustedWBrandAgentV4UnsubscribeRoute,
} from "./wbrandAgentConnectionScope.js";
import { createBackgroundSessionEventCoalescer } from "#src/wbrand-agent/wbrandSessionEventCoalescer.js";
...
import { WBrandAgentMcpStatusModeUnsupportedError } from "#src/wbrand-agent/wbrandAgentErrors.js";
import { WBrandAgentProcessManager } from "./wbrandAgentProcessManager.js";
import type { WBrandAgentProcessManagerOptions } from "./wbrandAgentProcessManager.js";
import type { IOffPeakTaskService } from "#src/session/offPeakTask.js";
import {
  WBrandProtocolRequestTimeoutError,
  type WBrandProtocolClient,
} from "./wbrandProtocolClient.js";
import { getDataBaseDir } from "../paths.js";
import {
  collectBrowserAmbientContext,
  type BrowserAmbientContextExecutor,
} from "./wbrandAgentBrowserAmbientContext.js";
import {
...
const logger = createServiceLogger("wbrand-agent-service");
...
interface PendingPermissionRequest {
  client: WBrandProtocolClient;
  protocolRequestId: WBrandProtocolRequestId;
}

interface PendingProviderRuntimeHeadersRequest extends PendingPermissionRequest {
  request: WBrandProviderRuntimeHeadersRequestParams;
  responding?: boolean;
}

interface PendingSessionRuntimePreferencesRequest extends PendingPermissionRequest {
  request: WBrandAgentSessionRuntimePreferencesRequest;
...
function isClosedStdioTransportError(error: unknown): boolean {
  return error instanceof Error && error.message === "WBrand agent stdio transport is closed";
}
...
function buildWorkspaceRef(params: WBrandAgentWorkspaceTarget): WBrandWorkspaceRef {
  return {
...
function savedWorkflowTargetHasWorkspace(
  params: WBrandAgentSavedWorkflowTarget,
): params is WBrandAgentWorkspaceTarget & { scope?: WBrandSavedWorkflowScope } {
  return typeof (params as Partial<WBrandAgentWorkspaceTarget>).workspacePath === "string";
}

// 只在 `scope` 有定义时下推到 RPC params：不给 scope 的项目档保持与今天逐字一致的线上形状。
function savedWorkflowScopeParam(params: WBrandAgentSavedWorkflowTarget): {
  scope?: WBrandSavedWorkflowScope;
} {
  return params.scope === undefined ? {} : { scope: params.scope };
}

function ensurePluginManagementWorkspacePath(): string {
  const workspacePath = join(getDataBaseDir(), ".wbrand", PLUGIN_MANAGEMENT_WORKSPACE_DIR_NAME);
...
// NOTE: this counts ONLY the per-session MCP servers passed through the WBrand Protocol
// session/create params (the app→protocol channel). It is deliberately independent of the
// CLI/bootstrap MCP servers configured in ~/.wbrand/cli/config.json (mcp.servers), which the agent
// runtime connects separately and reports via the `mcp.server.connected`/toolCount events. So a
// createSession log line with mcpServerCount:0 is EXPECTED when wbrand-cua is a CLI-config MCP server
...
// real kimi-k2.6 turns call mcp__wbrand-cua__* tools (get_app_state/type/open_application, status
...
function isProtocolRequestTimeout(error: unknown, method: string): boolean {
  if (error instanceof WBrandProtocolRequestTimeoutError) {
    return error.method === method;
  }
  return error instanceof Error && error.message === `WBrand Protocol request timed out: ${method}`;
}
...
function buildSessionCreateParams(
  params: WBrandAgentCreateSessionParams & {
...
function buildSessionResumeParams(
  params: WBrandAgentResumeSessionParams & {
    offPeakToolEnabled?: boolean;
    dynamicWorkflowEnabled?: boolean;
  },
...
function buildSessionSendParams(
  params: WBrandAgentSendPromptParams,
...
function buildSessionCompactParams(params: WBrandAgentCompactParams) {
  return {
    sessionId: params.sessionId,
    inputId: params.inputId,
...
function formatModelSelectionForLog(ref: ModelSelection | undefined): string | null {
  ...
  return reasoningLevel ? `${base}${WBRAND_MODEL_REASONING_SEPARATOR}${reasoningLevel}` : base;
}

function sessionEventKey(params: WBrandAgentSessionTarget): string {
...
function permissionRequestKey(params: WBrandAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function userInputRequestKey(params: WBrandAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function providerRuntimeHeadersRequestKey(
  params: WBrandAgentSessionTarget & { requestId: string },
): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}
...
interface WBrandAgentProviderReadinessSnapshot {
...
): WBrandAgentProviderReadinessSnapshot {
...
interface WaitingWorkspaceStartup {
  ...
  workspace: WBrandAgentWorkspaceTarget;
}
...
function createRuntimeUnavailableError(params: WBrandAgentWorkspaceTarget): Error & {
  code: typeof WBRAND_AGENT_RUNTIME_UNAVAILABLE_CODE;
  workspaceKey: string;
} {
  const error = new Error("WBrand Agent runtime is not running.") as Error & {
    code: typeof WBRAND_AGENT_RUNTIME_UNAVAILABLE_CODE;
    workspaceKey: string;
  };
  error.code = WBRAND_AGENT_RUNTIME_UNAVAILABLE_CODE;
  error.workspaceKey = resolveWorkspaceKey(params);
  return error;
}

interface CreateWBrandAgentServiceOptions extends Omit<
  WBrandAgentProcessManagerOptions,
  "idleTimeoutMs"
> {
  ...
  resolveSessionRuntimePreferences?: (
    scope: WBrandSessionRuntimePreferencesScope,
  ) => Promise<WBrandSessionRuntimePreferencesResult>;
  /** manual run 落库后由当前 host 直接派发；返回时 prompt 必须已被 session 接受。 */
  onAutomationManualRunRequested?: (params: {
    automation: WBrandAutomation;
    run: WBrandAutomationRun;
  }) => Promise<void>;
  /**
...
function toProtocolAutomation(automation: WBrandAutomation) {
  return {
...
async function respondOffPeakInternalError(
  client: Pick<WBrandProtocolClient, "respondError">,
  request: { id: WBrandProtocolRequestId; method: string },
  workspace: WBrandAgentWorkspaceTarget,
  error: unknown,
): Promise<void> {
...
export function createWBrandAgentService(
  options?: CreateWBrandAgentServiceOptions,
): IWBrandAgentService & { disposeAllAndWait(): Promise<void> } {
  const processManager = new WBrandAgentProcessManager(options);
  ...
  const pluginProcessManager = new WBrandAgentProcessManager({
  ...
  const mcpStatusProcessManager = new WBrandAgentProcessManager({
    commandResolver: options?.commandResolver,
    presentationSurface: options?.presentationSurface,
  ...
  const sessionEmitters = new Map<string, Emitter<WBrandAgentServiceEvent>>();
  /**
  ...
  const sessionRuntimePreferencesRequestEmitter =
    new Emitter<WBrandAgentSessionRuntimePreferencesRequest>();
  const processResourceSampleEmitter = new Emitter<AgentLaneResourceSample>();
  const toolExecResourceEmitter = new Emitter<WBrandToolExecResource>();
  const mcpResourceSamplesEmitter = new Emitter<WBrandMcpResourceSample[]>();
  const mcpTelemetryEmitter = new Emitter<WBrandMcpTelemetryEvent>();
  const pluginOperationProgressEmitters = new Map<
    string,
    Emitter<WBrandPluginOperationProgressNotification>
  >();
  ...
  const cuaPermissionObservationEmitter = new Emitter<WBrandAgentCuaPermissionObservation>();
  ...
  const wiredClients = new WeakSet<WBrandProtocolClient>();
  const clientDisposables = new WeakMap<WBrandProtocolClient, IDisposable[]>();
  ...
  let latestAppRuntimePreferences: WBrandAgentAppRuntimePreferences | undefined;
  ...
  const accountConfigSyncByClient = new WeakMap<WBrandProtocolClient, Promise<void>>();
  // 此缓存只去重已交付的账号快照，不表示 Worker 的 Registry 已应用该版本。
  const accountConfigReceivedRevisionByClient = new WeakMap<WBrandProtocolClient, string>();
  ...
  function invalidateWorkspaceClient(workspaceKey: string, client: WBrandProtocolClient): void {
  ...
  async function respondAccountRequestAuthWithoutInteraction(params: {
    ...
    try {
      ...
      logger.info(undefined, "WBrand provider runtime headers 已应用", {
      ...
      if (pendingProviderRuntimeHeaders.get(params.key) !== params.pending) return;
      logger.warn(undefined, "WBrand provider runtime headers 应用失败", {
        modelId: params.pending.request.modelSelection.modelId,
        providerId: params.pending.request.providerId,
        requestId: params.pending.request.requestId,
        sessionId: params.pending.request.sessionId,
  ...
  function expireSessionRuntimePreferencesRequest(requestId: string): void {
    ...
    logger.warn(undefined, "运行时偏好请求等待 Host 响应超时", {
      event: "wbrand_agent.runtime_preferences.host_response_timeout",
      module: "services.wbrand_agent",
      requestId,
      scope: pending.request.scope,
      sessionId: pending.request.sessionId,
      timeoutMs: WBRAND_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
    ...
    const current = previous
      ...
      .then(async () => {
        ...
        const result = await params.client.request(
          wbrandProtocolMethods.providerUpdateAccountConfig,
          {
            revision: snapshot.revision,
            basedOnWBrandBuiltinRevision: snapshot.basedOnWBrandBuiltinRevision,
        ...
        logger.info(undefined, "account provider config 已交付到 WBrand agent", {
  ...
  function enqueueInteractionPreferenceSync(params: {
    client: WBrandProtocolClient;
    preferences: WBrandAgentAppRuntimePreferences;
    workspace: WBrandAgentWorkspaceTarget;
  }): Promise<void> {
    ...
    const current = previous
      ...
      .then(async () => {
        await params.client.request(
          wbrandProtocolMethods.workspaceUpdateInteractionPreferences,
          {
        ...
        try {
          await params.client.request(
            wbrandProtocolMethods.workspaceUpdateModelIoPreferences,
            {
              workspace: buildWorkspaceRef(params.workspace),
              preferences: {
  ...
  async function handleProviderReadinessChanged(event: {
    reason: string;
    snapshot: WBrandAgentProviderReadinessSnapshot;
  }): Promise<void> {
    if (event.snapshot.readiness.ready) {
      await Promise.allSettled(
        Array.from(waitingWorkspaceStartups.entries()).map(async ([workspaceKey, waiting]) => {
          ...
          logger.info(undefined, "provider/model 就绪后已启动等待中的 WBrand agent", {
  ...
  function getSessionEmitter(params: WBrandAgentSessionTarget) {
    const key = sessionEventKey(params);
    const existing = sessionEmitters.get(key);
    if (existing) {
      return existing;
    }
    const created = new Emitter<WBrandAgentServiceEvent>();
  ...
  function getPluginOperationProgressEmitter(operationId: string) {
    ...
    let created: Emitter<WBrandPluginOperationProgressNotification>;
    created = new Emitter({
  ...
  function getConversationFrameEmitter(workspace: WBrandAgentWorkspaceTarget) {
  ...
  function getConversationTelemetryFactEmitter(workspace: WBrandAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getSessionsIndexFrameEmitter(workspace: WBrandAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getWorkspaceConfigFrameEmitter(workspace: WBrandAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function resolveV4Connection(params: unknown, fallbackConnectionId: string = v4ConnectionId) {
    return (
      readTrustedWBrandAgentV4Connection(params) ?? {
  ...
  function resolveV4UnsubscribeRoute(
    params: WBrandAgentConversationUnsubscribeParams | WBrandAgentConversationResyncParams,
    topicPrefix: string,
  ): V4SubscriptionRoute | null {
    const expectedWorkspaceKey = resolveWorkspaceKey(params);
    const trusted = readTrustedWBrandAgentV4UnsubscribeRoute(params);
    if (trusted) {
  ...
  async function unsubscribeV4Route(
    params: WBrandAgentConversationUnsubscribeParams,
    topicPrefix: string,
  ): Promise<void> {
  ...
  async function resyncV4Route(params: WBrandAgentConversationResyncParams, topicPrefix: string) {
    const route = resolveV4UnsubscribeRoute(params, topicPrefix);
  ...
  function handleStateUpdated(
    workspace: WBrandAgentWorkspaceTarget,
    notification: WBrandStateUpdatedNotification,
  ): void {
  ...
  function wireClient(
    ...
    const disposables = [
      client.onNotification((message) => {
        if (message.method === wbrandProtocolNotifications.providerRuntimeHeadersCancelled) {
          const parsed = wbrandProviderRuntimeHeadersCancelledSchema.safeParse(message.params);
          if (
            !parsed.success ||
        ...
        if (message.method === wbrandProtocolNotifications.processResourceSample) {
          const parsed = wbrandProcessResourceSampleSchema.safeParse(message.params);
          if (parsed.success) {
            processResourceSampleEmitter.fire({ ...parsed.data, lane });
          } else {
            logger.debug(undefined, "丢弃无效 WBrand CLI 资源样本", {
        ...
        if (message.method === wbrandProtocolNotifications.toolExecResource) {
          const parsed = wbrandToolExecResourceSchema.safeParse(message.params);
          if (parsed.success) toolExecResourceEmitter.fire(parsed.data);
          return;
        }
        if (message.method === wbrandProtocolNotifications.mcpResourceSamples) {
          const parsed = wbrandMcpResourceSamplesSchema.safeParse(message.params);
          if (parsed.success) mcpResourceSamplesEmitter.fire(parsed.data);
          else logger.debug(undefined, "丢弃无效 MCP 资源样本");
          return;
        }

        if (message.method === wbrandProtocolNotifications.mcpTelemetry) {
          const parsed = wbrandMcpTelemetryEventSchema.safeParse(message.params);
          if (parsed.success) {
            mcpTelemetryEmitter.fire(parsed.data);
          } else {
            logger.debug(undefined, "丢弃无效 WBrand CLI MCP 遥测事件", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                path: issue.path.join("."),
              })),
        ...
        if (message.method === wbrandProtocolNotifications.pluginOperationProgress) {
          const parsed = wbrandPluginOperationProgressNotificationSchema.safeParse(message.params);
          if (parsed.success) {
            pluginOperationProgressEmitters.get(parsed.data.operationId)?.fire(parsed.data);
          } else {
            logger.warn(undefined, "丢弃无效 WBrand Protocol 插件操作进度", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
        ...
        if (message.method === wbrandProtocolMethods.computerUseOperationEvent) {
          const parsed = wbrandComputerUseOperationEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(undefined, "丢弃无效 WBrand Protocol Computer Use operation event", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                message: issue.message,
                path: issue.path.join("."),
        ...
        if (message.method === "session/event") {
          const parsed = wbrandSessionEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(
              ...
              "丢弃无效 WBrand Protocol session event",
              {
        ...
        if (message.method === "state.updated") {
          const parsed = wbrandStateUpdatedNotificationSchema.safeParse(message.params);
          if (parsed.success) {
      ...
      client.onRequest((request) => {
        if (request.method === wbrandProtocolMethods.sessionRequestRuntimePreferences) {
          ...
          const parsed = wbrandSessionRequestRuntimePreferencesParamsSchema.safeParse(
            request.params,
          );
          if (!parsed.success) {
            void client
          ...
          if (sessionRuntimePreferencesAuthority === "local") {
            void (async () => {
              let preferences: WBrandSessionRuntimePreferencesResult;
              try {
                preferences = wbrandSessionRuntimePreferencesResultSchema.parse(
          ...
          const dynamicRequest: WBrandAgentSessionRuntimePreferencesRequest = {
            ...parsed.data,
            requestId,
          };
          ...
          logger.info(undefined, "运行时偏好请求已转发给 Host", {
            event: "wbrand_agent.runtime_preferences.host_request_dispatched",
            module: "services.wbrand_agent",
            requestId,
        ...
        if (request.method === wbrandProtocolMethods.interactionRequestPermission) {
          const parsed = wbrandPermissionRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
        ...
        if (request.method === wbrandProtocolMethods.interactionRequestUserInput) {
          const parsed = wbrandUserInputRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === wbrandProtocolMethods.interactionRequestProviderRuntimeHeaders) {
          const parsed = wbrandProviderRuntimeHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
          ...
          logger.info(request.trace?.traceId, "收到 WBrand provider runtime headers 请求", {
        ...
        if (request.method === wbrandProtocolMethods.interactionRequestOfficialMcpAuthHeaders) {
          const parsed = wbrandOfficialMcpAuthHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === wbrandProtocolMethods.interactionBrowserList) {
          const parsed = wbrandBrowserListParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === wbrandProtocolMethods.interactionBrowserExecute) {
          const parsed = wbrandBrowserExecuteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === wbrandProtocolMethods.automationCreate) {
          const parsed = wbrandAutomationCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === wbrandProtocolMethods.offPeakCreate) {
          const parsed = wbrandOffPeakCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === wbrandProtocolMethods.offPeakList) {
          const parsed = wbrandOffPeakListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === wbrandProtocolMethods.automationList) {
          const parsed = wbrandAutomationListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === wbrandProtocolMethods.automationCheckTaskBinding) {
          const parsed = wbrandAutomationCheckTaskBindingParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === wbrandProtocolMethods.automationUpdate) {
          const parsed = wbrandAutomationUpdateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === wbrandProtocolMethods.automationDelete) {
          const parsed = wbrandAutomationDeleteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        void client.respondError(request.id, {
          code: -32601,
          message: `Unsupported WBrand Protocol request: ${request.method}`,
        });
      }),
      client.onClose(() => {
  ...
  function rememberSessionTrace(
    target: WBrandAgentSessionTarget,
  ...
  function getSessionTraceId(target: WBrandAgentSessionTarget): TraceId | undefined {
  ...
  function createProviderNotReadyError(params: {
    ...
    code: typeof WBRAND_AGENT_PROVIDER_NOT_READY_CODE;
    data: {
      providerCount: number;
      reason: typeof WBRAND_AGENT_PROVIDER_NOT_READY_REASON;
    ...
    error.code = WBRAND_AGENT_PROVIDER_NOT_READY_CODE;
    error.data = {
      providerCount: params.snapshot?.providerCount ?? 0,
      reason: WBRAND_AGENT_PROVIDER_NOT_READY_REASON,
  ...
  function isProviderNotReadyError(
    error: unknown,
  ): error is Error & { code: typeof WBRAND_AGENT_PROVIDER_NOT_READY_CODE } {
    return (
      error instanceof Error &&
      (error as { code?: unknown }).code === WBRAND_AGENT_PROVIDER_NOT_READY_CODE
    );
  }

  async function resolveStartupReadiness(): Promise<
    WBrandAgentProviderReadinessSnapshot | undefined
  > {
  ...
  function isReusableActiveClientEntry(
    ...
    activeClientsByWorkspaceKey.delete(workspaceKey);
    interactionPreferenceSyncByWorkspaceKey.delete(workspaceKey);
    logger.warn(undefined, "复用的 WBrand Protocol client 已 disposed，清理 stale entry", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return false;
  ...
  async function getOrStartReadOnlyClient(
    ...
    const interactionPreferencesReady = (async () => {
      let appliedSnapshot: WBrandAgentAppRuntimePreferences | undefined;
    ...
    const offPeakToolPolicyReady = (async () => {
      ...
      try {
        await client.request(
          wbrandProtocolMethods.workspaceUpdateOffPeakToolPolicy,
    ...
    const dynamicWorkflowPolicyReady = (async () => {
      ...
      try {
        await client.request(
          wbrandProtocolMethods.workspaceUpdateDynamicWorkflowPolicy,
          { workspace: buildWorkspaceRef(params), enabled: true },
          wbrandWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
        );
      } catch (error) {
    ...
    logger.info(undefined, "为只读会话控制面启动 WBrand agent", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return entry;
  ...
  async function getClient(params: WBrandAgentWorkspaceTarget) {
    const workspaceKey = resolveWorkspaceKey(params);
    const active = activeClientsByWorkspaceKey.get(workspaceKey);
    ...
    if (!readinessSnapshot || !readiness?.ready) {
      ...
      if (waiting.lastLoggedRevision !== revision) {
        ...
        logger.info(
          undefined,
          active
            ? "provider/model 尚未就绪，WBrand agent 保持只读"
            : "provider/model 尚未就绪，WBrand agent 保持未启动",
          {
    ...
    waitingWorkspaceStartups.delete(workspaceKey);
    logger.info(undefined, "provider/model 就绪，允许 WBrand agent 模型执行", {
  ...
  async function getPluginManagementClient(): Promise<WBrandProtocolClient> {
  ...
  // homedir() 即用户家目录，全局根 `~/.wbrand/workflows/` 因此解析到真实目录。
  // 远程 runtime（SSH/WSL identity 或带 remoteSessionId）的 home 不是本机，绝不选它当载体。
  function isLocalActiveWorkspaceClient(workspace: WBrandAgentWorkspaceTarget): boolean {
    return (
      !workspace.remoteSessionId &&
      !(workspace.workspaceIdentity && isRemoteWorkspaceIdentity(workspace.workspaceIdentity))
    );
  ...
  async function resolveSavedWorkflowCarrier(
    params: WBrandAgentSavedWorkflowTarget,
  ): Promise<{ client: WBrandProtocolClient; workspace: WBrandWorkspaceRef }> {
  ...
  async function getMcpStatusClient(): Promise<WBrandProtocolClient> {
    const workspace = { workspacePath: ensurePluginManagementWorkspacePath() };
  ...
  async function buildConversationCommandEnvelope(
    params: WBrandAgentConversationCommandParams,
  ...
  return {
    ...
    async initialize(params: WBrandAgentWorkspaceTarget): Promise<WBrandAgentInitializeResult> {
      const workspaceKey = resolveWorkspaceKey(params);
      const startedAt = Date.now();
      logger.info(undefined, "开始初始化 WBrand agent", {
        workspaceKey,
        workspacePath: params.workspacePath,
      });
      try {
        const client = await getClient(params);
        logger.info(undefined, "WBrand agent 初始化完成", {
        ...
        return {
          available: true,
          workspaceKey,
          protocolName: WBRAND_PROTOCOL_NAME,
          protocolVersion: WBRAND_PROTOCOL_VERSION,
          transportKind: client.transportKind === "websocket" ? "websocket" : "stdio",
        };
      } catch (error) {
        ...
        logger[providerNotReady ? "info" : "warn"](
          undefined,
          providerNotReady ? "WBrand agent 等待 provider/model 就绪" : "WBrand agent 初始化失败",
          {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            workspaceKey,
        ...
        return {
          ...
          ...(providerNotReady ? { reasonCode: WBRAND_AGENT_PROVIDER_NOT_READY_REASON } : {}),
        };
      }
    },

    async syncAppRuntimePreferences(preferences: WBrandAgentAppRuntimePreferences): Promise<void> {
      const normalizedPreferences: WBrandAgentAppRuntimePreferences = {
        ...preferences,
    ...
    async getWorkspaceRuntimeIdentity(params: WBrandAgentWorkspaceTarget) {
    ...
    async createSession(params: WBrandAgentCreateSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      logger.info(sessionTraceId, "开始请求 WBrand Protocol session/create", {
      ...
      try {
        const snapshot = await client.request(
          wbrandProtocolMethods.sessionCreate,
        ...
        logger.info(sessionTraceId, "WBrand Protocol session/create 完成", {
          durationMs: Date.now() - startedAt,
        ...
        if (compatFields.length === 0) {
          logger.warn(sessionTraceId, "WBrand Protocol session/create 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            persistence: params.persistence,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId, "WBrand Protocol session/create 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
        ...
        if (!compatFields.includes("thoughtLevel") || !params.thoughtLevel) {
          logger.info(sessionTraceId, "WBrand Protocol session/create 兼容重试完成", {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
            snapshotTraceId: snapshot.session.traceId ?? null,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        const snapshotWithThoughtLevel = await client.request(
          wbrandProtocolMethods.sessionSetThoughtLevel,
          {
            sessionId: snapshot.session.sessionId,
            thoughtLevel: params.thoughtLevel,
        ...
        logger.info(
          sessionTraceId,
          "WBrand Protocol session/create 兼容重试后设置 thoughtLevel 完成",
          {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
    ...
    async resumeSession(params: WBrandAgentResumeSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      const dynamicWorkflowEnabled = await resolveDynamicWorkflowGate();
      logger.info(cachedTraceId, "开始请求 WBrand Protocol session/resume", {
        mcpServerCount: getMcpServerCount(params),
        mcpServerNames: getMcpServerNames(params),
      ...
      try {
        const snapshot = await client.request(
          wbrandProtocolMethods.sessionResume,
        ...
        logger.info(sessionTraceId, "WBrand Protocol session/resume 完成", {
          durationMs: Date.now() - startedAt,
          messageCount: snapshot.messages.length,
          modelCurrent: formatModelSelectionForLog(snapshot.settings.model.current),
          mcpServerCount: getMcpServerCount(params),
        ...
        if (compatFields.length === 0) {
          logger.warn(cachedTraceId, "WBrand Protocol session/resume 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(cachedTraceId, "WBrand Protocol session/resume 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        const sessionTraceId = rememberSessionTrace(params, snapshot) ?? cachedTraceId;
        logger.info(sessionTraceId, "WBrand Protocol session/resume 兼容重试完成", {
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          snapshotTraceId: snapshot.session.traceId ?? null,
          workspaceKey: resolveWorkspaceKey(params),
    ...
    async listSessions(params: WBrandAgentListSessionsParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const result = await client.request(
        wbrandProtocolMethods.sessionList,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async listSessionSubagents(params: WBrandAgentListSessionSubagentsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        wbrandProtocolMethods.sessionSubagents,
        {
          sessionId: params.sessionId,
    ...
    async getAppUsageStats(params: WBrandAgentAppUsageParams) {
    ...
    async getTaskTokenUsage(params: WBrandAgentTaskTokenUsageParams) {
      const client = await getReadOnlyClient(params);
    ...
    async readSession(params: WBrandAgentReadSessionParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      ...
      const snapshot = await client.request(
        wbrandProtocolMethods.sessionRead,
        {
          sessionId: params.sessionId,
    ...
    async readSessionMessages(params: WBrandAgentReadSessionMessagesParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        wbrandProtocolMethods.sessionMessages,
        {
          sessionId: params.sessionId,
    ...
    async readSessionDebug(params) {
      ...
      return client.request(
        wbrandProtocolMethods.sessionDebug,
        { sessionId: params.sessionId },
        sessionDebugSnapshotSchema,
      );
    },

    async readSessionEvents(params: WBrandAgentReadSessionEventsParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        wbrandProtocolMethods.sessionEvents,
        {
          sessionId: params.sessionId,
          afterSeq: params.afterSeq,
          limit: params.limit,
    ...
    async readWorkspacePresentation(params: WBrandAgentReadWorkspacePresentationParams) {
      const startedAt = Date.now();
      logger.info(undefined, "开始请求 WBrand Protocol workspace/readPresentation", {
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      });
      try {
        let presentation: WBrandWorkspacePresentation | undefined;
        for (let attempt = 0; attempt < 2; attempt += 1) {
          ...
          try {
            ...
            presentation = await client.request(
              wbrandProtocolMethods.workspaceReadPresentation,
              { workspace: buildWorkspaceRef(params) },
              wbrandWorkspacePresentationSchema,
            );
            break;
        ...
        if (!presentation) {
          throw new Error("WBrand Protocol workspace/readPresentation did not return a result");
        }
        logger.info(undefined, "WBrand Protocol workspace/readPresentation 完成", {
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(undefined, "WBrand Protocol workspace/readPresentation 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
    ...
    async grantWorkspaceHookTrust(params: WBrandAgentGrantWorkspaceHookTrustParams) {
    ...
    async listMcpServerStatuses(params: WBrandAgentListMcpServerStatusesParams) {
      ...
      try {
        ...
        if (params.mode === "status" && unrecognizedKeys.includes("mode")) {
          ...
          throw new WBrandAgentMcpStatusModeUnsupportedError();
        }
        if (
        ...
        if (!isProtocolRequestTimeout(error, wbrandProtocolMethods.mcpList)) {
          throw error;
        }
    ...
    async listPlugins(params: WBrandAgentPluginViewParams) {
      const requestPluginsList = async () => {
        ...
        return client.request(
          wbrandProtocolMethods.pluginsList,
          {
            workspace: buildWorkspaceRef(params),
      ...
      try {
        ...
        if (!isProtocolRequestTimeout(error, wbrandProtocolMethods.pluginsList)) {
          throw error;
        }
    ...
    async getPluginReferenceCatalog(params: WBrandAgentPluginReferenceCatalogParams) {
    ...
    async getSkillReferenceCatalog(params: WBrandAgentSkillReferenceCatalogParams) {
      // 与 Plugin 引用一样，Session 快照只存在于 workspace agent 进程；独立管理进程
      // 没有 resident Session，不能作为对话 authority。
      const client = await getReadOnlyClient(params);
      return client.request(
        wbrandProtocolMethods.skillsReferenceCatalog,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.sessionId ? { sessionId: params.sessionId } : {}),
        },
    ...
    // `scope` 只在有定义时下推。
    async listSavedWorkflows(params: WBrandAgentListSavedWorkflowsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        wbrandProtocolMethods.workflowsList,
        { workspace, ...savedWorkflowScopeParam(params) },
        wbrandWorkflowsListResultSchema,
      );
    },

    async getSavedWorkflow(params: WBrandAgentGetSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        wbrandProtocolMethods.workflowsGet,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        wbrandWorkflowsGetResultSchema,
      );
    },

    async updateSavedWorkflowMeta(params: WBrandAgentUpdateSavedWorkflowMetaParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        wbrandProtocolMethods.workflowsUpdateMeta,
        { workspace, name: params.name, meta: params.meta, ...savedWorkflowScopeParam(params) },
        wbrandWorkflowsUpdateMetaResultSchema,
      );
    },

    async deleteSavedWorkflow(params: WBrandAgentDeleteSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        wbrandProtocolMethods.workflowsDelete,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        wbrandWorkflowsDeleteResultSchema,
      );
    },

    async listSavedWorkflowRuns(params: WBrandAgentListSavedWorkflowRunsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        wbrandProtocolMethods.workflowsRuns,
        {
          workspace,
    ...
    async moveSavedWorkflow(params: WBrandAgentMoveSavedWorkflowParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        wbrandProtocolMethods.workflowsMove,
    ...
    async collectLocalRuntimeChildProcesses(signal?: AbortSignal) {
      ...
      return Promise.all(
        managed.map(async (runtime) => {
          let children: WBrandProcessChildProcess[] = [];
          try {
            const result = await runtime.client.request(
              wbrandProtocolMethods.processChildProcesses,
              {},
              wbrandProcessChildProcessesResultSchema,
          ...
          return {
            pid: runtime.pid,
            provider: WBRAND_AGENT_PROVIDER,
    ...
    async getPluginsOverview(params: WBrandAgentPluginViewParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsOverview,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.configScope ? { configScope: params.configScope } : {}),
        },
    ...
    async addPluginMarketplace(params: WBrandAgentAddPluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsMarketplaceAdd,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async removePluginMarketplace(params: WBrandAgentRemovePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsMarketplaceRemove,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePluginMarketplace(params: WBrandAgentUpdatePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsMarketplaceUpdate,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async installPlugin(params: WBrandAgentInstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsInstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async cancelPluginOperation(params: WBrandAgentCancelPluginOperationParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsCancelOperation,
        { operationId: params.operationId },
        wbrandPluginsCancelOperationResultSchema,
    ...
    async uninstallPlugin(params: WBrandAgentUninstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsUninstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePlugin(params: WBrandAgentUpdatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsUpdate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginId ? { pluginId: params.pluginId } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async restoreBuiltinPlugin(params: WBrandAgentRestoreBuiltinPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsRestoreBuiltin,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async configurePlugin(params: WBrandAgentConfigurePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsConfigure,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async resetPluginConfig(params: WBrandAgentResetPluginConfigParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsResetConfig,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
          ...(params.scope ? { scope: params.scope } : {}),
    ...
    async validatePlugin(params: WBrandAgentValidatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsValidate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginName ? { pluginName: params.pluginName } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async describePlugin(params: WBrandAgentDescribePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsDescribe,
        {
          workspace: buildWorkspaceRef(params),
          marketplace: params.marketplace,
          pluginName: params.pluginName,
    ...
    async setPluginEnabled(params: WBrandAgentSetPluginEnabledParams) {
      const client = await getPluginManagementClient();
      return client.request(
        wbrandProtocolMethods.pluginsSetEnabled,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async listAutomations(params: WBrandAgentWorkspaceTarget) {
    ...
    async createAutomation(params: WBrandAgentCreateAutomationParams) {
      return automationService.create({
        ...
        mode: params.mode as WBrandTaskMode | undefined,
        workspacePath: params.workspacePath,
        workspaceIdentity: params.workspaceIdentity,
    ...
    async updateAutomation(params: WBrandAgentUpdateAutomationParams) {
      return automationService.update(
        params.automationId,
        {
          ...
          prompt: params.prompt,
          modelSelection: params.modelSelection,
          mode: params.mode === null ? null : (params.mode as WBrandTaskMode | undefined),
    ...
    async deleteAutomation(params: WBrandAgentAutomationIdParams) {
    ...
    async setAutomationEnabled(params: WBrandAgentSetAutomationEnabledParams) {
    ...
    async restartAutomation(params: WBrandAgentAutomationIdParams) {
    ...
    async runAutomationNow(params: WBrandAgentAutomationIdParams) {
    ...
    async listAutomationRuns(params: WBrandAgentAutomationIdParams) {
    ...
    async deleteAutomationRun(params: WBrandAgentDeleteAutomationRunParams) {
    ...
    async generateWorkspaceText(params: WBrandAgentGenerateWorkspaceTextParams) {
      const client = await getClient(params);
      // Worker 自己读取 WBrand Built-in / Personal Config；Host 只在执行前确保账号状态形成的
      ...
      const cancel = () => {
        ...
        void client
          .request(
            wbrandProtocolMethods.workspaceCancelGenerateText,
            { operationId },
            wbrandWorkspaceCancelGenerateTextResultSchema,
            { timeoutMs: 5_000 },
          )
      ...
      try {
        return await client.request(
          wbrandProtocolMethods.workspaceGenerateText,
          {
            workspace: buildWorkspaceRef(params),
    ...
    async testModelConnectivity(params: WBrandAgentTestModelConnectivityParams) {
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      return client.request(
        wbrandProtocolMethods.providerTestModelConnectivity,
        {
          workspace: buildWorkspaceRef(params),
          selection: params.selection,
        },
    ...
    async sendPrompt(params: WBrandAgentSendPromptParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      ...
      const protocolParams: WBrandAgentSendPromptParams = {
        ...params,
        ...(browserAmbientContext ? { browserAmbientContext } : {}),
      };
      logger.info(logTraceId, "WBrand Agent session/send 开始", {
      ...
      try {
        const result = await client.request(
          wbrandProtocolMethods.sessionSend,
          buildSessionSendParams(protocolParams),
          wbrandSessionSendResultSchema,
        );
        logger.info(logTraceId, "WBrand Agent session/send ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          queryId: params.queryId ?? null,
          sessionId: params.sessionId,
        ...
        if (compatFields.length > 0) {
          logger.warn(logTraceId, "WBrand Agent session/send 命中新旧协议兼容重试", {
            compatFields,
            durationMs: Date.now() - startedAt,
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(logTraceId, "WBrand Agent session/send 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          queryId: params.queryId ?? null,
    ...
    async compactSession(params: WBrandAgentCompactParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      const sessionTraceId = getSessionTraceId(params);
      logger.info(sessionTraceId ?? params.inputId, "WBrand Protocol session/compact 开始", {
        inputId: params.inputId,
        sessionId: params.sessionId,
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      ...
      try {
        const result = await client.request(
          wbrandProtocolMethods.sessionCompact,
        ...
        logger.info(sessionTraceId ?? params.inputId, "WBrand Protocol session/compact ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId ?? params.inputId, "WBrand Protocol session/compact 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          sessionId: params.sessionId,
    ...
    async goalSession(params: WBrandAgentGoalParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(params.inputId, "开始请求 WBrand Protocol session/goal", {
      ...
      try {
        const result = await client.request(
          wbrandProtocolMethods.sessionGoal,
          {
            sessionId: params.sessionId,
            inputId: params.inputId,
            action: params.action,
        ...
        logger.info(params.inputId, "WBrand Protocol session/goal 完成", {
          action: params.action,
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(params.inputId, "WBrand Protocol session/goal 失败", {
          action: params.action,
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          sessionId: params.sessionId,
    ...
    async closeSession(
      params: WBrandAgentSessionTarget & {
        expectedPersistence?: "deferred" | "immediate";
      },
    ): Promise<boolean> {
      const client = await getClient(params);
      const result = await client.request(
        wbrandProtocolMethods.sessionClose,
        {
          sessionId: params.sessionId,
    ...
    async setModel(params: WBrandAgentSetModelParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(undefined, "开始请求 WBrand Protocol session/setModel", {
      ...
      try {
        const snapshot = await client.request(
          wbrandProtocolMethods.sessionSetModel,
          {
            sessionId: params.sessionId,
            model: params.model,
            expectedRevision: params.expectedRevision,
        ...
        logger.info(undefined, "WBrand Protocol session/setModel 完成", {
          durationMs: Date.now() - startedAt,
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
        ...
        logger.warn(undefined, "WBrand Protocol session/setModel 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
    ...
    async setThoughtLevel(params: WBrandAgentSetThoughtLevelParams) {
      const client = await getClient(params);
      const snapshot = await client.request(
        wbrandProtocolMethods.sessionSetThoughtLevel,
        {
    ...
    async setMode(params: WBrandAgentSetModeParams) {
      const client = await getClient(params);
      return client.request(
        wbrandProtocolMethods.sessionSetMode,
        {
          sessionId: params.sessionId,
          mode: params.mode,
          expectedRevision: params.expectedRevision,
    ...
    async respondSessionRuntimePreferences(
      ...
      if (!pending) {
        logger.warn(undefined, "运行时偏好响应找不到 pending 请求", {
          event: "wbrand_agent.runtime_preferences.response_without_pending",
          module: "services.wbrand_agent",
    ...
    onDynamicSessionEvent(params: WBrandAgentSessionSubscribeParams) {
      ...
      return (listener) => {
        ...
        const pendingLiveEvents: WBrandAgentServiceEvent[] = [];
        ...
        const deliverToListener = (event: WBrandAgentServiceEvent): void => {
          if (cancelled) {
            return;
          }
        ...
        const establishSubscription = async (attempt: number): Promise<void> => {
          ...
          try {
            ...
            const result = await client.request(
              wbrandProtocolMethods.sessionSubscribe,
              {
                sessionId: params.sessionId,
                deliveryKind: params.deliveryKind,
                afterSeq: params.afterSeq,
            ...
            if (attempt >= SESSION_SUBSCRIBE_MAX_ATTEMPTS - 1) {
              ...
              console.warn(
                formatLogPrefix("wbrand-agent", process.pid),
    ...
    async setConnectionFlowStateV4(params: WBrandAgentConnectionFlowParams) {
      const trusted = readTrustedWBrandAgentV4Connection(params);
    ...
    async subscribeConversationV4(params: WBrandAgentConversationSubscribeParams) {
      ...
      // Account Config 顺序屏障，不提升模型执行权限。WBrand Built-in / Personal 仍由 Worker 维护。
    ...
    async unsubscribeConversationV4(params: WBrandAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "conversation/");
    },

    async resyncConversationV4(params: WBrandAgentConversationResyncParams) {
      return resyncV4Route(params, "conversation/");
    },

    async sendConversationCommandV4(params: WBrandAgentConversationCommandParams) {
      const client = await getClient(params);
      ...
      const commandClientMode =
        readTrustedWBrandAgentV4Connection(params)?.clientMode ??
        params.clientMode ??
        "desktop-continuous";
      if (params.envelope.type === "createSession") {
        // V4 草稿预热直接走 command 转发；新会话创建前只需等待 Account Config，
        // WBrand Built-in / Personal 已由 Worker 进程 Registry 自己装配。
        await ensureAccountProviderConfigSynced({
          client,
    ...
    async queryConversationCommandsV4(params: WBrandAgentCommandsQueryParams) {
      if (!readTrustedWBrandAgentV4Connection(params)) {
    ...
    async attachmentBeginV4(params: WBrandAgentAttachmentBeginParams) {
      const trusted = readTrustedWBrandAgentV4Connection(params);
    ...
    async attachmentChunkV4(params: WBrandAgentAttachmentChunkParams) {
      const trusted = readTrustedWBrandAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentCommitV4(params: WBrandAgentAttachmentTerminalParams) {
      const trusted = readTrustedWBrandAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentAbortV4(params: WBrandAgentAttachmentTerminalParams) {
      const trusted = readTrustedWBrandAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentReadV4(params: WBrandAgentAttachmentReadParams) {
      if (!readTrustedWBrandAgentV4Connection(params)) {
    ...
    async conversationAttachmentReadV4(params: WBrandAgentConversationAttachmentReadParams) {
      if (!readTrustedWBrandAgentV4Connection(params)) {
        throw new WBrandAttachmentFaultError(
          WBRAND_ATTACHMENT_FAULT_CODES.shareReadConnectionUntrusted,
        );
      }
    ...
    async conversationAttachmentStatV4(params: WBrandAgentConversationAttachmentStatParams) {
      if (!readTrustedWBrandAgentV4Connection(params)) {
        throw new WBrandAttachmentFaultError(
          WBRAND_ATTACHMENT_FAULT_CODES.shareStatConnectionUntrusted,
        );
      }
    ...
    async attachmentPreviewSourceV4(params: WBrandAgentAttachmentPreviewSourceParams) {
      const trusted = readTrustedWBrandAgentV4Connection(params);
    ...
    async conversationRowsRangeV4(params: WBrandAgentConversationRowsRangeParams) {
      const trusted = readTrustedWBrandAgentV4Connection(params);
    ...
    async conversationPlansV4(params: WBrandAgentConversationPlansParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunEventsV4(params: WBrandAgentConversationWorkflowRunEventsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunsV4(params: WBrandAgentConversationWorkflowRunsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async backgroundBashOutputV4(params: WBrandAgentBackgroundBashOutputParams) {
      if (!readTrustedWBrandAgentV4Connection(params))
    ...
    async conversationFileChangesV4(params: WBrandAgentConversationFileChangesParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationFileRewindPreviewV4(params: WBrandAgentConversationFileRewindPreviewParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    onDynamicConversationFrame(params: WBrandAgentWorkspaceTarget) {
      return getConversationFrameEmitter(params).event;
    },

    onDynamicLocalTtftFacts(params: WBrandAgentWorkspaceTarget) {
    ...
    onDynamicConversationTelemetryFact(params: WBrandAgentWorkspaceTarget) {
    ...
    async subscribeSessionsIndexV4(params: WBrandAgentSessionsIndexSubscribeParams) {
    ...
    async unsubscribeSessionsIndexV4(params: WBrandAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "sessions-index/");
    },

    async resyncSessionsIndexV4(params: WBrandAgentConversationResyncParams) {
      return resyncV4Route(params, "sessions-index/");
    },

    onDynamicSessionsIndexFrame(params: WBrandAgentWorkspaceTarget) {
    ...
    async subscribeWorkspaceConfigV4(params: WBrandAgentWorkspaceConfigSubscribeParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const connection = resolveV4Connection(params, v4ConnectionIdFor(params.subscriberScope));
    ...
    async unsubscribeWorkspaceConfigV4(params: WBrandAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "workspace-config/");
    },

    async resyncWorkspaceConfigV4(params: WBrandAgentConversationResyncParams) {
      return resyncV4Route(params, "workspace-config/");
    },

    onDynamicWorkspaceConfigFrame(params: WBrandAgentWorkspaceTarget) {
    ...
    onAgentRuntimeLifecycle(listener: (event: WBrandAgentRuntimeLifecycleEvent) => void) {
