import type { ServiceAuthorityMode } from "@wbrand/shared";

export type WBrandAgentPresentationSurface = "desktop";

interface WBrandAgentPresentationHostFacts {
...
export function resolveWBrandAgentPresentationSurface(
  facts: WBrandAgentPresentationHostFacts,
): WBrandAgentPresentationSurface | undefined {
