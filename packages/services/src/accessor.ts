...
import type { IWBrandTaskService } from "./session/wbrandTaskService.js";
import type { IWBrandAgentService } from "./wbrand-agent/wbrandAgent.js";
import type { IWBrandSessionService } from "./wbrand-session/wbrandSession.js";
...
export interface IServiceAccessor {
  ...
  /** 设置页插件管理（UI 不再直触 wbrandAgentService 的 plugins/* 面） */
