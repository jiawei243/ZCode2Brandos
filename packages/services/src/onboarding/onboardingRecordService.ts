...
import { onboardingRecordFileSchema } from "@wbrand/shared";
import { appSettingsOccupationEnum } from "@wbrand/shared";
import type {
...
function getRecordFile(): string {
  // 记录是设备级数据，必须跟随 dataBaseDir（用户自定义数据目录时落在其 .wbrand/v2 下，
