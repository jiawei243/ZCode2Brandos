import { formatLogPrefix, type TraceId } from "@wbrand/shared";
...
export function createServiceLogger(
  ...
  function write(
    ...
    // 服务层日志过去常被复用到 WBrand Agent 命名 logger，导致新 WBrand 路径继续依赖 WBrand Agent 目录。
    // 这里把通用分级日志抽到独立模块，后续删除 WBrand Agent runtime 时不会牵连非 WBrand Agent 服务。
