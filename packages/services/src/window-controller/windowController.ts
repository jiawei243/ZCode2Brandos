...
import type { WBrandArchivedTaskDeletionResult } from "#src/session/wbrandTaskService.js";
import type {
  WBrandTaskListItem,
  WBrandTaskListQuery,
  WBrandTaskListResult,
} from "../session/wbrandTaskListTypes.js";
...
export type WindowHostControllerTaskListItem = WBrandTaskListItem & {
...
export interface WindowHostControllerTaskListResult extends Omit<WBrandTaskListResult, "items"> {
...
export interface IWindowControllerService {
  ...
  listTaskList(params: WBrandTaskListQuery): Promise<WindowHostControllerTaskListResult>;
  mutateTask(params: {
    address: WindowHostTaskAddress;
