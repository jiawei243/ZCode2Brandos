...
import { HELPER_ADDON_ENV, WINDOWS_DEV_CONTROL_PROTOCOL } from "@wbrand/wbrand-cua/broker/server";
...
/**
 * Parse a `wbrand-cua-windows-dev/v1` control message from the helper child.
 *
