import { BIGMODEL_PROVIDER_ID, buildBigModelApiUrl } from "@wbrand/shared";
...
export function createBigModelProviderRuntimeConfig(
  ...
  return {
    ...
    tokenUrl:
      ...
      buildWBrandApiUrlFromEnv(env, "/api/v1/oauth/token"),
    ...
    // 当前 BigModel callback 只消费 wbrand OAuth token 路由，显式 appSecret 仅保留给
