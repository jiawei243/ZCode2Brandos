...
const APP_CA_CERT_FILE = "wbrand-network-ca.pem";
const APP_CA_KEY_FILE = "wbrand-network-ca.key";
...
function generateSelfSignedCa(): { certPem: string; keyPem: string } {
  ...
  const attrs = [
    { name: "commonName", value: "WBrand Network CA" },
    { name: "organizationName", value: "WBrand" },
  ];
