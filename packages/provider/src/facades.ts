...
export class ProviderSettingsFacade {
  ...
  getView(): ProviderSettingsView {
    ...
    return createProviderSettingsView({
      ...
      wbrandBuiltinProviders: snapshot.config.wbrandBuiltinProviders,
      wbrandBuiltinProviderTemplates: snapshot.config.wbrandBuiltinProviderTemplates,
  ...
  resolveModelConfig(input: ResolveModelConfigInput): ModelConfigResolution {
    ...
    if (!("personalConfig" in input)) {
      const modelRules = ModelConfigRules.composeEffective(
        snapshot.config.wbrandBuiltinModelRules,
    ...
    const inheritedConfig = snapshot.config.wbrandBuiltinModelRules.resolve({
      providerId: input.providerId,
      templateId: provider.templateId,
      modelId: input.modelId,
      apiType: provider.config.api?.type,
...
function createProviderSettingsView(input: {
  revision: number;
  wbrandBuiltinProviders: ProviderRegistryServiceSnapshot["config"]["wbrandBuiltinProviders"];
  wbrandBuiltinProviderTemplates: ProviderRegistryServiceSnapshot["config"]["wbrandBuiltinProviderTemplates"];
  ...
  return Object.freeze({
    ...
    providerTemplates: Object.freeze(
      (input.wbrandBuiltinProviderTemplates ?? ProviderTemplateMap.empty())
        .entries()
