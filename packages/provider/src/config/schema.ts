import { z } from "zod";
import { modelConfigDataSchema } from "@wbrand/shared/model-config";
...
export function parseWBrandBuiltinProviderConfigMap(input: unknown): ProviderConfigMap {
...
export function parseWBrandBuiltinProviderConfigRules(input: unknown): {
...
export function parseWBrandBuiltinModelConfigRules(input: unknown): ModelConfigRules {
