...
export class ProviderRegistryService {
  ...
  async #runRefreshLoop(): Promise<void> {
    ...
    while (this.#completedGeneration < this.#requestedGeneration) {
      ...
      if (account.basedOnWBrandBuiltinRevision !== config.wbrandBuiltinRevision) {
      ...
      try {
        const resolution = this.#resolver.resolve({
          wbrandBuiltinProviders: config.wbrandBuiltinProviders,
          wbrandBuiltinProviderTemplates: config.wbrandBuiltinProviderTemplates,
          personalProviders: config.personalProviders,
          wbrandBuiltinModelRules: config.wbrandBuiltinModelRules,
