...
import type { ApplicationIconInfo } from "@wbrand/shared";
...
public static class WBrandAumidIcon {
...
'@;
$wbrandIconBytes=[WBrandAumidIcon]::Read($wbrandArg0);
[Console]::Out.Write([Convert]::ToBase64String($wbrandIconBytes));
`;
