...
function buildForceUpdatePromptMessages(locale: Locale) {
  ...
  return {
    ...
    checkingMessage: "Keep this window open while WBrand checks for updates.",
    downloadingTitle: "Downloading update",
    downloadingVersionTitle: "Downloading update v{version}",
    downloadingMessage: "WBrand will install the update automatically after download.",
    readyTitle: "Update downloaded",
    readyMessage: "WBrand is preparing to restart and install the update.",
    installingTitle: "Installing update",
    installingMessage: "WBrand will restart to finish installing the update.",
    ...
    <main class="panel" role="dialog" aria-modal="true" aria-labelledby="title">
      <header class="titlebar">
        <div class="brand">
          ...
          <div class="brand-title">WBrand</div>
        </div>
