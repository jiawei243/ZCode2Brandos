...
const WORKFLOW_NAME = "Open in WBrand.workflow";
const WORKFLOW_BUNDLE_ID = "dev.wbrand.app.finder-open-workflow";
const WORKFLOW_VERSION = "5";
const SERVICES_MENU_LABELS: Record<Locale, string> = {
  "zh-CN": "在WBrand中打开",
  "en-US": "Open in WBrand",
};
...
if [ -n "$first" ]; then
  ...
  /usr/bin/open "wbrand://workspace/open?path=\${encoded}"
fi
`;
