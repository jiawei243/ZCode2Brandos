...
import { HELPER_APP_NAME } from "@wbrand/wbrand-cua/broker/helperConstants";
import {
...
export { normalizeCuaHelperArch, normalizeCuaHelperArchs } from "@wbrand/services/node";
...
export function createDesktopCuaHelperInstaller(
  ...
  if (bundledAppPath) {
    delete env.WBRAND_CUA_HELPER_ALLOW_UNSIGNED_LOCAL;
  }
