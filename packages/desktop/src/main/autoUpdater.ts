...
import type { ISettingService } from "@wbrand/services";
import {
  DEFAULT_LOCALE,
...
const UPDATE_FEED_URL_ENV = "WBRAND_UPDATE_FEED_URL";
const UPDATE_FEED_URL_SWITCH = "--wbrand-update-feed-url";
const DEV_AUTO_UPDATE_ENV = "WBRAND_AUTO_UPDATE_DEV";
const DEV_AUTO_UPDATE_SWITCH = "--wbrand-auto-update-dev";
const DEV_AUTO_UPDATE_VERSION_ENV = "WBRAND_AUTO_UPDATE_DEV_VERSION";
const DEV_AUTO_UPDATE_VERSION_SWITCH = "--wbrand-auto-update-dev-version";
...
type UpdateDownloadedInfoLike = {
  ...
  wbrandReleaseChannel?: ElectronReleaseChannel | null;
...
function readUpdateInfoReleaseChannel(
  ...
  return info.wbrandReleaseChannel === "preview" || info.wbrandReleaseChannel === "stable"
    ? info.wbrandReleaseChannel
    : null;
}
...
function applyManifestUpdateProvider(options: InitAutoUpdaterOptions): void {
  ...
  autoUpdater.setFeedURL({
    ...
    resolveEndpointOrigin:
      options.resolveEndpointOrigin ?? (() => resolveRuntimeWBrandEndpointOrigin(process.env)),
