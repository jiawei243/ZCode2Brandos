...
function mapMcpTelemetryEvent(event: Exclude<WBrandMcpTelemetryEvent, { kind: "memory" }>): {
...
function processProperties(
  event: Extract<WBrandMcpTelemetryEvent, { kind: "process_start" | "process_crash" }>,
