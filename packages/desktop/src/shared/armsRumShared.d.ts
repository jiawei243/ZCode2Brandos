import { type WBrandRuntimeEnv } from "@wbrand/shared";
...
export declare function buildArmsBrowserInitConfig(runtimeEnv: WBrandRuntimeEnv): {
  enable: boolean;
  version: string;
  endpoint: string;
  env: import("@wbrand/shared").ArmsRumEnv;
  sessionConfig: {
    sampleRate: number;
  };
  spaMode: false;
