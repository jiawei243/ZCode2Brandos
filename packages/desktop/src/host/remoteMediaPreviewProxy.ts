...
import type { IFileService, IMediaPreviewService, MediaPreviewPreparation } from "@wbrand/services";
import { getMediaPreviewFormat, type WindowHostAttachmentScope } from "@wbrand/shared";
import {
...
const MEDIA_ROUTE_PREFIX = "/__wbrand_media/";
