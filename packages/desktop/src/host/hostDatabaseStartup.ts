import {
  ...
  resolveWBrandAgentSpawnCwd,
} from "@wbrand/services/storage-startup";
import type { DatabaseStartupState } from "@wbrand/shared";
    ...
    prepare: async (report) => {
      ...
      try {
        ...
        for (const candidate of candidates) {
          ...
          const { cwd } = await resolveWBrandAgentSpawnCwd({
