...
import type { WBrandArchivedTaskDeletionResult } from "@wbrand/services";
import {
...
export interface WindowHostControllerSessionOverlay {
  ...
  updatedAt?: number;
  pendingInteraction?: WBrandTaskMeta["pendingInteraction"];
...
export type WindowHostControllerMutationResult = void | boolean | WBrandArchivedTaskDeletionResult;
...
function defaultLiveStatus(meta: WBrandTaskMeta): WindowHostControllerTaskRow["liveStatus"] {
