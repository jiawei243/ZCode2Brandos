import { Event as RpcEvent } from "@wbrand/rpc";
import type { IConversationShareService, IWBrandAgentService } from "@wbrand/services";
import { conversationShareConnectionScopeFactory } from "@wbrand/services/node";
