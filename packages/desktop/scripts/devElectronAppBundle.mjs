...
export const DEV_ELECTRON_PROTOCOL_SCHEME = "wbrand";
export const DEV_ELECTRON_APP_NAME = "WBrand Dev";
export const DEV_ELECTRON_APP_BUNDLE_ID = "dev.wbrand.app.development";
...
/**
 * 为 macOS 本地 Dev runtime 写入产品身份和 wbrand URL scheme。
 * raw Electron 的 Info.plist 没有 CFBundleURLTypes，系统只能把 wbrand 交给
...
export async function prepareDevElectronAppBundle({
  ...
  const sourceStampPath = join(dirname(appPath), ".wbrand-dev-electron-source.json");
