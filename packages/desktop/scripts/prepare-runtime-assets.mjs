...
const shouldPrepareWindowsBrowserImportHelper =
  target.os === "win32" && process.env.WBRAND_ENABLE_WINDOWS_BROWSER_IMPORT === "1";
...
const shouldSkipRemoteAssets = process.env.WBRAND_SKIP_REMOTE_ASSETS === "1";
...
if (!shouldSkipRemoteAssets) {
  ...
  console.log("[prepare:runtime-assets] skip prepare:remote-assets (WBRAND_SKIP_REMOTE_ASSETS=1)");
}
