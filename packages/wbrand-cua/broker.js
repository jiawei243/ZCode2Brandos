...
export const BROKER_SOCKET_ENV = "WBRAND_CUA_PERMISSION_BROKER_SOCKET";
export const BROKER_UNAVAILABLE_ENV = "WBRAND_CUA_PERMISSION_BROKER_UNAVAILABLE";
...
export function mintBrokerSocketPath(options = {}) {
  ...
  return join(dir, `wbrand-cua-broker-${randomUUID()}.sock`);
}
