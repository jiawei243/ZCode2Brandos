...
export const HELPER_ADDON_ENV = "WBRAND_CUA_HELPER_ADDON";
export const WINDOWS_DEV_CONTROL_PROTOCOL = "wbrand-cua-windows-dev/v1";
...
export function isPotentialWBrandCuaAgentMcpServer(_server) {
  return false;
}
