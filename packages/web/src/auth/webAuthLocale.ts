...
const WEB_AUTH_COPY = {
  "zh-CN": {
    ...
    loginDescription: "使用与桌面端一致的 UNEW.CC 账号身份访问当前远控入口。",
    loginAction: "用 UNEW.CC 登录",
  ...
  "en-US": {
    ...
    loginDescription: "Use the same UNEW.CC account identity as desktop for Web remote control.",
    loginAction: "Sign in with UNEW.CC",
