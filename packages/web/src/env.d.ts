declare module "*.css";
declare module "@wbrand/ui/styles.css";
...
interface ImportMetaEnv {
  ...
  readonly VITE_WBRAND_BASE_URL?: string;
  readonly VITE_WBRAND_ENDPOINT_ORIGIN?: string;
  readonly VITE_WBRAND_WEB_REMOTE_CONTROL_RELAY_WS_URL?: string;
}
