...
// Vite 配置在 Node 加载期执行，不能导入 @wbrand/shared 根入口。
...
} from "@wbrand/shared/wbrandEndpoint";
...
export default defineConfig(({ mode }) => {
  ...
  const wbrandEndpointOrigin = resolveRuntimeWBrandEndpointOrigin(endpointEnv);
