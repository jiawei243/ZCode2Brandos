...
const { content: wbrandBuiltinProviderConfigJson } = await loadBuiltinProviderConfig();
...
export default defineConfig({
  ...
  splitting: false,
  banner: {
    js: 'import { fileURLToPath as __wbrandFileURLToPath } from "node:url"; import { dirname as __wbrandDirname } from "node:path"; const __filename = __wbrandFileURLToPath(import.meta.url); const __dirname = __wbrandDirname(__filename);',
  },
  noExternal: ["@wbrand/shared", "@wbrand/rpc", "@wbrand/services"],
