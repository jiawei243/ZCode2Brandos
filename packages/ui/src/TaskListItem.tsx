...
import { isCronTask, isOffPeakTask, type WBrandTaskMeta } from "@wbrand/shared";
import { TID_TASK_ARCHIVE, TID_TASK_ITEM, testId } from "@wbrand/shared";
...
function getTaskAutomationIdentity(task: WBrandTaskMeta): string | undefined {
  return task.cronAutomationId ?? (task as WBrandTaskMeta & { automationId?: string }).automationId;
}

function areTaskListItemTaskFieldsEqual(left: WBrandTaskMeta, right: WBrandTaskMeta) {
  if (left === right) {
    return true;
  }
