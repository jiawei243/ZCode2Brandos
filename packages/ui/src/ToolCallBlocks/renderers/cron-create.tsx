...
import { TID_CRON_CREATE_CARD, TID_CRON_CREATE_OPEN } from "@wbrand/shared";
import type { WBrandAutomationScheduleRule } from "@wbrand/shared";
...
function isScheduleRule(value: unknown): value is WBrandAutomationScheduleRule {
...
function readCronCreateAutomationOutputSummary(value: unknown): CronCreateAutomationSummary | null {
  ...
  const scheduleRule = isScheduleRule(automation.scheduleRule)
    ? (automation.scheduleRule as WBrandAutomationScheduleRule)
    : undefined;
