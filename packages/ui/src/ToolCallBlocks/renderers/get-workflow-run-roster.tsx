 ...
 *
 * 一行的读法与模型面
 * （apps/wbrand-cli/packages/core/src/tool/handlers/get-workflow-run-format-roster.ts）同一句话：
...
import type { ToolCallGetWorkflowRunDisplay } from "@wbrand/shared/wbrand-protocol-v4";
...
type FormatMessage = ReturnType<typeof useWBrandIntl>["intl"]["formatMessage"];
