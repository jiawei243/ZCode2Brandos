...
import type { ApplicationIconRequest } from "@wbrand/shared";
import { useWBrandIntl } from "@/i18n/IntlProvider.js";
import { isWBrandCuaToolName } from "@/lib/cuaPermissionAction.js";
...
function readCuaToolName(value: string | null | undefined): string | null {
  ...
  //   main namesp: mcp__plugin_wbrand_cua_computer_use__<action>
...
export function isCuaToolCall(
  ...
  return collectToolNames(toolCall).some(isWBrandCuaToolName);
}
...
type CuaIntl = ReturnType<typeof useWBrandIntl>["intl"];
