...
import { extractPlanStepsFromToolInput, extractPlanStepsFromToolOutput } from "@wbrand/shared";
import type { WBrandPlanStep } from "@wbrand/shared";
...
const todoTextClasses: Record<WBrandPlanStep["status"], string> = {
  pending: "text-foreground-subtle",
  in_progress: "text-foreground",
  completed: "text-foreground-subtlest line-through",
};

function readTodoPlan(context: ToolCallBlockRenderContext): WBrandPlanStep[] | null {
...
function TodoStatusIcon({ status }: { status: WBrandPlanStep["status"] }) {
  if (status === "completed") {
