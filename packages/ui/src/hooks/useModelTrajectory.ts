 ...
 *
 * 路径解析与文件读取都收口在 wbrandTaskService.getModelTrajectory（host 侧），
...
export function useModelTrajectory(
  ...
  }, [wbrandTaskService, taskId, workspaceIdentity, workspacePath, reloadToken]);
