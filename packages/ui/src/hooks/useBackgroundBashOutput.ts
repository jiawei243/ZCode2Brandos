...
import type { BackgroundBashOutput, BackgroundBashOutputResult } from "@wbrand/shared";
import { useWBrandAgentService } from "@/hooks/useWBrandAgentService.js";
...
export function useBackgroundBashOutput(target: BackgroundBashOutputTarget, visible: boolean) {
  ...
  const service = useWBrandAgentService(workspacePath, remoteSessionId, workspaceIdentity);
