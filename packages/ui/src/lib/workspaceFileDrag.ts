...
export const WORKSPACE_FILE_DRAG_MIME = "application/x-wbrand-workspace-file";
export const WORKSPACE_FILE_ADD_TO_CHAT_EVENT = "wbrand:add-workspace-file-to-chat";
export const WORKSPACE_FILE_DRAG_STATE_EVENT = "wbrand:workspace-file-drag-state";
