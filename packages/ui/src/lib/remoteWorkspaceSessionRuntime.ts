...
interface MarkRemoteWorkspaceRunningTasksFailedParams {
  ...
  getWorkspaceState: WBrandSessionStoreState["getWorkspaceState"];
  setTaskRuntimeState: WBrandSessionStoreState["setTaskRuntimeState"];
  reason: string;
}

function isRunningRuntimeStatus(status: WBrandTaskRuntimeStatus): boolean {
...
function collectRemoteWorkspaceRunningTaskIds(workspaceState: WorkspaceWBrandUIState): string[] {
