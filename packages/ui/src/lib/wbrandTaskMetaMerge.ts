...
function hasOwnTaskMetaField<T extends keyof WBrandTaskMeta>(task: WBrandTaskMeta, key: T) {
...
function resolveMergedTaskTitle(preferredTask: WBrandTaskMeta, fallbackTask: WBrandTaskMeta): string {
...
export function mergeTaskMetaCandidates(
  ...candidates: Array<WBrandTaskMeta | null | undefined>
): WBrandTaskMeta | undefined {
  let merged: WBrandTaskMeta | undefined;
