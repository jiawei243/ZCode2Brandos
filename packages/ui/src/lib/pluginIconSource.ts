...
const OFFICIAL_PLUGIN_ICON_BY_ID: Readonly<Record<string, string>> = {
  "documents@wbrand-plugins-official": documentsIconUrl,
  "image-search@wbrand-plugins-official": imageSearchIconUrl,
  "pdf@wbrand-plugins-official": pdfIconUrl,
  "plugin-creator@wbrand-plugins-official": pluginCreatorIconUrl,
  "presentations@wbrand-plugins-official": presentationsIconUrl,
  "spreadsheets@wbrand-plugins-official": spreadsheetsIconUrl,
};
