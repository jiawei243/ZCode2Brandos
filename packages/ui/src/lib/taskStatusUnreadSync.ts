...
import type { WBrandTaskMeta, WBrandWorkspaceTaskListChanged } from "@wbrand/shared";
...
import { getTaskUnreadIndicator, useWBrandSessionStore } from "@/store/wbrandSessionStore.js";
import { bumpTaskListMembershipVersion } from "@/v4/taskListMembershipVersion.js";
import { logger } from "@/logger.js";

type TaskUnreadService = Pick<IWBrandTaskService, "setTaskUnread">;
...
function buildStatusUnreadKey(event: WBrandWorkspaceTaskListChanged, taskId: string): string {
...
function shouldMarkStatusEventTaskUnread(params: {
  ...
  event: WBrandWorkspaceTaskListChanged;
}): boolean {
