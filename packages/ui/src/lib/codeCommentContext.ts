export const CODE_COMMENT_ADD_TO_CHAT_EVENT = "wbrand:code-comment-add-to-chat";
export const CODE_COMMENT_REMOVE_FROM_CHAT_EVENT = "wbrand:code-comment-remove-from-chat";
