...
import type { AccountProviderState } from "@wbrand/provider";
import type {
  OAuthProviderId,
...
async function refreshAccountProviderAccesses(params: {
  ...
  accesses: ReadonlyMap<string, WBrandProviderAccountAccess | WBrandAccountAccess>;
  ...
  try {
    ...
    const accesses = new Map(
      params.providerIds.flatMap((providerId) => {
        ...
        const query: WBrandProviderAccountAccess | WBrandAccountAccess =
