...
export type IntlShape = ReturnType<typeof useWBrandIntl>["intl"];
...
export function CallCard({
  ...
  index: number;
  inputMessages: WBrandModelTrajectoryMessage[];
...
function SourceTitle({ record, intl }: { record: WBrandModelTrajectoryRecord; intl: IntlShape }) {
  const callSource: NonNullable<WBrandModelTrajectoryRecord["callSource"]> = record.callSource ?? {
    kind: "main",
  };
...
function sourceLabelId(callSource: NonNullable<WBrandModelTrajectoryRecord["callSource"]>): string {
...
function MessageBlock({
  ...
  message: WBrandModelTrajectoryMessage;
...
function ResponseBlock({
  ...
  response: NonNullable<WBrandModelTrajectoryRecord["response"]>;
  callStartedAt: string;
  callDurationMs?: number;
