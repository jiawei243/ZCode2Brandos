...
import type { UserCommand, WBrandCommand } from "@wbrand/shared";
import { isPluginCommand, isUserCommand } from "@wbrand/shared";
...
export function isEditableUserCommand(command: WBrandCommand): command is UserCommand {
  return isUserCommand(command) && command.location.source === "wbrand";
}

interface CommandCardProps {
  command: WBrandCommand;
  onEdit?: (command: WBrandCommand) => void;
  onToggle?: (command: WBrandCommand, enabled: boolean) => void;
  isOperating?: boolean;
