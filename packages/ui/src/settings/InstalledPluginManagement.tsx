...
import type { WBrandPluginDiagnostic, WBrandPluginInfo } from "@wbrand/shared";
 ...
 */
export function PluginWarningList({ warnings }: { warnings: WBrandPluginDiagnostic[] }) {
  return (
...
export function PluginHookDetails({
  ...
  hooks: NonNullable<WBrandPluginInfo["hookDetails"]>;
}) {
...
function formatHookCommand(hook: NonNullable<WBrandPluginInfo["hookDetails"]>[number]): string {
