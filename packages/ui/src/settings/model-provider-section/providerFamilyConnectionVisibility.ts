...
export function resolveCodingPlanEntitlementState({
  ...
  accountAvailability?: import("@wbrand/provider").AccountProviderState["availability"];
  accountUnavailableReason?: import("@wbrand/provider").AccountProviderState["unavailableReason"];
      ...
      return [
        {
          ...
          subscriptionRenewTime: null,
          subscriptionExpireTime: null,
          // Team Plan 项目没有可用 wbrand-team-api-key 时，不能继续当作已启用连接方式。
