import type { WBrandConfigOption, WBrandProvider } from "@wbrand/shared";
...
export function buildAutomationModeOption(currentValue: string): WBrandConfigOption {
  return {
    id: "mode",
    name: "Mode",
    category: "mode",
...
export function resolveAutomationModelItem(
  ...
  // workspace runtime 也可能返回 wbrand-openai-compatible/model 这类包装值，provider 对不上时
...
export function buildAutomationThoughtLevelOption(
  runtimeOption: WBrandConfigOption | undefined,
  currentValue: string,
