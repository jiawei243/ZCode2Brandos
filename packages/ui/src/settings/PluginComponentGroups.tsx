import type { WBrandPluginComponentKind } from "@wbrand/shared";
...
export interface PluginComponentDisplayGroup {
  kind: WBrandPluginComponentKind;
...
const COMPONENT_BADGE_STYLES: Record<WBrandPluginComponentKind, string> = {
...
const COMPONENT_LABEL_IDS: Record<WBrandPluginComponentKind, string> = {
