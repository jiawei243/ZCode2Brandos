...
import type { McpSource, WBrandMcpServer } from "@wbrand/shared";
...
export function McpServerForm({
  ...
  onSave: (form: FormState, prevServer?: WBrandMcpServer) => void;
  onCancel: () => void;
  onDelete?: (server: WBrandMcpServer) => void;
}) {
  const { intl } = useWBrandIntl();
