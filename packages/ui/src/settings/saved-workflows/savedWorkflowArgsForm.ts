...
import type { WBrandSavedWorkflowArgType, WBrandSavedWorkflowArgsDeclaration } from "@wbrand/shared";

export interface SavedWorkflowArgField {
  name: string;
  type: WBrandSavedWorkflowArgType;
  description?: string;
  required: boolean;
  hasDefault: boolean;
...
function formatSavedWorkflowArgValue(type: WBrandSavedWorkflowArgType, value: unknown): string {
...
export function buildSavedWorkflowArgFields(
  declaration: WBrandSavedWorkflowArgsDeclaration | undefined,
...
type SavedWorkflowArgRowsCollect =
  | { ok: true; args: WBrandSavedWorkflowArgsDeclaration | undefined }
...
export function rowsToArgsDeclaration(
  ...
  const args: WBrandSavedWorkflowArgsDeclaration = {};
