...
import type { WBrandPluginMarketplaceSummary } from "@wbrand/shared";
...
function isRemovableMarketplace(marketplace: WBrandPluginMarketplaceSummary): boolean {
...
function PluginStoreSourceRefreshFailure({
  ...
  failure: NonNullable<WBrandPluginMarketplaceSummary["refreshFailure"]>;
}) {
