...
function CodingPlanQuotaCards({
  ...
  accountAccess:
    | import("@wbrand/shared").WBrandProviderAccountAccess
    | import("@wbrand/shared").WBrandAccountAccess
    | undefined;
            ...
            <div key={card.key} className="min-w-0 flex-1 rounded-xl bg-surface/70 p-4">
              ...
              <div className="flex min-h-5 min-w-0 items-center gap-1">
                ...
                {card.key === "serverMcp" ? (
                  <ControlHintTooltip
                    title={intl.formatMessage({
                      id: "sidebar.usage.plan.wbrandMcpDescription",
                    })}
                    standalone
                  >
                    <button
                      ...
                      data-wbrand-mcp-info="usage-stats"
                    >
