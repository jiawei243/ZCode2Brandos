import type { McpServerConfig, WBrandMcpServer } from "@wbrand/shared";

export const MCP_SECTIONS = ["wbrandagentmcp"] as const;
...
export function serverToForm(server: WBrandMcpServer): FormState {
...
// 与 shared 层 convertToWBrandAgentMcpServer 的 isMcpProtocolVersion 守卫保持同一语义：
