...
interface OffPeakEditViewProps {
  editing: WBrandOffPeakTask | null;
  ...
  onDelete?: (task: WBrandOffPeakTask) => void;
  onDeleteHistory?: (task: WBrandOffPeakTask) => void;
  onPause?: (task: WBrandOffPeakTask) => void;
  onContinue?: (task: WBrandOffPeakTask) => void;
...
export function OffPeakEditView({
  ...
  const thoughtLevelOption = useMemo<WBrandConfigOption | null>(
    () =>
    ...
    >
      ...
      {tab === "history" ? (
        <OffPeakHistoryTab
          ...
          {...(onOpenSession
            ? {
                onOpenSession: (task: WBrandOffPeakTask) =>
                  task.sessionId
                    ? onOpenSession({
