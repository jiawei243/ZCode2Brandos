...
import type {
  ...
  WBrandImportedSessionSkippedItem,
} from "@wbrand/shared";
...
function ImportIssuesList({
  ...
  title: string;
  items: WBrandImportedSessionSkippedItem[];
}) {
...
export function MigrationCandidatesCard({
  ...
  candidates: WBrandImportableSessionCandidate[];
  selectedSessionIds: string[];
  selectedCount: number;
  importError: string | null;
  lastImportResult: WBrandImportSessionsResult | null;
  isImporting: boolean;
