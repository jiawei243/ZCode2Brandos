...
function McpServerItem({
  ...
  server: WBrandMcpServer;
  onEdit: (server: WBrandMcpServer) => void;
  onToggle: (id: string, enabled: boolean) => void;
  onOpenAuthorization?: (server: WBrandMcpServer) => void;
  ...
  const canEdit = !server.location || server.location.source === "wbrand";
