...
import type { CommandConfig, UserCommand, WBrandCommand } from "@wbrand/shared";
...
export function CommandsSection({
  ...
  const handleToggle = useCallback(
    async (command: WBrandCommand, enabled: boolean) => {
  ...
  const renderCommandList = (items: WBrandCommand[]) => (
    <SettingsResourceList
      items={items}
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <CommandForm
            ...
            agentSource={editingCommand?.agentSource ?? WBRAND_COMMAND_AGENT_SOURCE}
            scopeKey={formScopeKey}
