...
function PluginList({
  ...
  const getPluginOptionValue = (
    ...
    key: string,
    option: WBrandPluginUserConfigOption,
  ...
  const savePluginOptions = async (plugin: WBrandPluginInfo) => {
  ...
  const renderPluginRows = (items: WBrandPluginInfo[]) => (
  ...
  return (
    <section className="space-y-6" aria-labelledby="plugin-installed-title">
      ...
      <RemoteSyncDialogs
        ...
        remoteWBrandAgentService={targetServiceResolution.services.wbrandAgentService}
