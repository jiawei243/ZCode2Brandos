...
import { compareDocumentPluginPriority, isPluginCommand, isUserCommand } from "@wbrand/shared";
...
export function selectBuiltInPlugins(
  ...
  installedPlugins: readonly WBrandInstalledPluginSummary[],
): WBrandPluginInfo[] {
...
interface PluginSettingsGroups {
  installed: WBrandPluginInfo[];
  builtIn: WBrandPluginInfo[];
}
...
export function selectPluginsForScope(
  plugins: readonly WBrandPluginInfo[],
  _installedPlugins: readonly WBrandInstalledPluginSummary[],
  _scope: WBrandPluginScope,
): WBrandPluginInfo[] {
...
export function selectSkillsForScope(
  ...
  scopedPlugins: readonly Pick<WBrandPluginInfo, "id" | "name" | "enabled">[],
...
export function selectCommandsForScope(
  commands: readonly WBrandCommand[],
  scopedPlugins: readonly Pick<WBrandPluginInfo, "id" | "name" | "enabled">[],
  scope: WBrandPluginScope,
): WBrandCommand[] {
  const enabledPlugins = scopedPlugins.filter((plugin) => plugin.enabled);
