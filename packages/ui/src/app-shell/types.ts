...
import type { IFeedbackService, IServiceAccessor } from "@wbrand/services";
...
import type { WorkspaceWBrandUIState } from "@/store/wbrandSessionStore.js";
...
export interface WorkspaceShellWBrandState {
  activeTaskId: WorkspaceWBrandUIState["activeTaskId"];
  draftFocusVersion: WorkspaceWBrandUIState["draftFocusVersion"];
  modelSwitchPending: WorkspaceWBrandUIState["modelSwitchPending"];
  modelSwitchStage: WorkspaceWBrandUIState["modelSwitchStage"];
  selectedProvider: WorkspaceWBrandUIState["selectedProvider"];
  optimisticTaskListByTaskId: WorkspaceWBrandUIState["optimisticTaskListByTaskId"];
  workspaceInit: WorkspaceWBrandUIState["workspaceInit"];
  taskStatus: WBrandTaskRuntimeStatus;
...
export type CreateTaskRequest = WBrandProvider | CreateTaskOptions;
...
export interface WorkspaceShellLayoutProps extends Omit<AppProps, "baseFeedbackService"> {
  ...
  workspaceTabs: Array<{
    ...
    remoteTarget?: import("@wbrand/shared").RemoteTarget;
    workspaceIdentity?: string;
  ...
  handleStartDraftInWorkspace: (
    targetWorkspacePath: string,
    targetWorkspaceIdentity?: string,
    targetWorkspacePurpose?: import("@wbrand/shared").WorkspacePurpose,
    createSource?: SessionCreateSource,
  ) => void;
