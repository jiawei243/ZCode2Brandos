...
import { TID_APP_HEADER } from "@wbrand/shared";
...
import type { ComposerMentionPrefill } from "@/store/wbrandSessionStoreTypes.js";
...
const WORKSPACE_SIDEBAR_WIDTH_STORAGE_KEY = "wbrand:workspace-shell:sidebar-width-px";
...
export const WorkspaceShellLayout = memo(function WorkspaceShellLayoutComponent({
  ...
  usePaneSessionPersistence({
    ...
    draftFocusVersion: workspaceShellWBrandState.draftFocusVersion,
  ...
  return (
    <DesktopWindowFrame
      title={`WBrand / ${getPathLeaf(workspaceAbsPath)}`}
      showHeader
      isDesktop={isDesktop}
                    ...
                    {shouldRenderWorkspaceHeader ? (
                      ...
                      >
                        <WorkspaceHeader
                          ...
                          workspaceHeaderState={workspaceShellWBrandState}
                          gitSummary={gitState.summary}
