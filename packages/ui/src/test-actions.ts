...
export interface TestActions extends TaskListE2EActions {
  ...
  /** E2E 通过真实 wbrandAgentService 拉取插件 overview */
  getPluginsOverview: IWBrandAgentService["getPluginsOverview"];
  /** E2E 通过真实 wbrandAgentService 添加 marketplace */
  addPluginMarketplace: IWBrandAgentService["addPluginMarketplace"];
  /** E2E 通过真实 wbrandAgentService 刷新 marketplace */
  updatePluginMarketplace: IWBrandAgentService["updatePluginMarketplace"];
  /** E2E 通过真实 wbrandAgentService 安装 marketplace plugin */
  installPlugin: IWBrandAgentService["installPlugin"];
  /** E2E 通过真实 wbrandAgentService 触发插件 discover */
  listPlugins: IWBrandAgentService["listPlugins"];
  /** E2E 通过真实 wbrandAgentService 查询 Workspace/Session Plugin catalog */
  getPluginReferenceCatalog: IWBrandAgentService["getPluginReferenceCatalog"];
}
