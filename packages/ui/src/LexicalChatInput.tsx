...
function E2ELexicalInputBridgePlugin({ inputTestId }: { inputTestId?: string }) {
  ...
  useEffect(() => {
    ...
    const detachBridge = (input: HTMLElement | null) => {
      if (
        input &&
        (input as { __wbrandLexicalInputE2E?: typeof bridge }).__wbrandLexicalInputE2E === bridge
      ) {
        delete (input as { __wbrandLexicalInputE2E?: typeof bridge }).__wbrandLexicalInputE2E;
      }
    ...
    const attachBridge = (input: HTMLElement | null) => {
      ...
      Object.defineProperty(input, "__wbrandLexicalInputE2E", {
        configurable: true,
        value: bridge,
      });
