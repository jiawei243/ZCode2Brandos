...
import type { CuaAccessibilitySettingsResult, CuaPermissionKind } from "@wbrand/shared";
import { requiredCuaPermissionsForRequestAccessStatus } from "@wbrand/shared/wbrand-protocol-v4";
import {
  isCuaPermissionStatusAvailable,
  type CuaPermissionRestartOptions,
  type CuaPermissionStatusResult,
  type WBrandAgentCuaPermissionObservation,
...
function cuaPermissionObservationKey(observation: WBrandAgentCuaPermissionObservation): string {
...
export function CuaPermissionObservationAttachment() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      typeof services.wbrandAgentService.onDynamicCuaPermissionObservation !== "function"
    ) {
      return;
    }
    ...
    let disposed = false;
    const subscription = services.wbrandAgentService.onDynamicCuaPermissionObservation()(
      (observation) => {
        const missing = requiredCuaPermissionsForRequestAccessStatus(observation.permissionStatus);
