import type { IPlatformService, Locale, UpdateStatePayload } from "@wbrand/shared";
import { useCallback, useEffect, useRef, useState } from "react";
import { WBrandIntlProvider } from "@/i18n/IntlProvider.js";
...
export function UpdateStatusWindowRoot({
  ...
  return (
    <div className="min-h-screen bg-transparent text-foreground">
      ...
      <WBrandIntlProvider key={locale} initialLocale={locale}>
