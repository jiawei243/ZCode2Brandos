...
import type { SettingsSyncCategory, SettingsSyncDiscoveryResult } from "@wbrand/shared";
...
function formatAgentName(agent: string, intl: ReturnType<typeof useWBrandIntl>["intl"]): string {
  switch (agent) {
    case "wbrand":
      return intl.formatMessage({ id: "settingsSync.agent.wbrand" });
    case "claudeCode":
