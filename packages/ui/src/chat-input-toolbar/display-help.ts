...
export const WBRAND_MODE_OPTION_LABEL_IDS: Record<WBrandProvider, Record<string, string>> = {
  glm: {
...
export const WBRAND_MODE_OPTION_DESCRIPTION_IDS: Record<WBrandProvider, Record<string, string>> = {
  glm: {
