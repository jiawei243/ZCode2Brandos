...
type ContextUsageBreakdownSource = WBrandContextUsageBreakdownItem["source"];
...
function buildContextUsageBreakdownSegments(
  breakdown: readonly WBrandContextUsageBreakdownItem[] | undefined,
...
export function getRenderableTaskUsage<T extends { used: number; size: number }>(
  ...
  // WBrand Protocol 迁移后会单独补齐真实 contextUsed/contextWindow。
...
export function getContextCompressionCommand(_provider: WBrandProvider): string {
  return "/compact";
}
