...
//
// sessions-index / Controller tasks-index 每个内容帧都会全量重建 WBrandTaskMeta[]，
...
export function buildTaskListItemIdentityKey(meta: WBrandTaskMeta): string {
...
export function stabilizeTaskListItems<T extends WBrandTaskMeta>(previous: T[], next: T[]): T[] {
