...
const TASK_LIST_ROW_ACTIVITY_FIELD = "__wbrandSessionActivity" as const;
...
export type TaskListMetaWithActivity = WBrandTaskMeta & {
  [TASK_LIST_ROW_ACTIVITY_FIELD]: TaskListRowActivity;
};

export function attachTaskListRowActivity<T extends WBrandTaskMeta>(
  task: T,
...
export function getTaskListRowActivity(task: WBrandTaskMeta): TaskListRowActivity | null {
...
function isTaskListRowRunning(task: WBrandTaskMeta): boolean {
 ...
 */
export function isTaskListRowActive(task: WBrandTaskMeta): boolean {
...
export function mergeTaskListMembershipFields(
  activityTask: WBrandTaskMeta,
  membershipTask: WBrandTaskMeta,
): WBrandTaskMeta {
