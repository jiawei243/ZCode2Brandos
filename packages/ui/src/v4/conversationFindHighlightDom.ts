...
const FIND_HIGHLIGHT_NAME = "wbrand-v4-conversation-find";
const ACTIVE_FIND_HIGHLIGHT_NAME = "wbrand-v4-conversation-find-active";
const SEARCH_RESULT_HIGHLIGHT_NAME = "wbrand-v4-conversation-search-result";

const FIND_STYLE_ID = "wbrand-v4-conversation-find-highlight-style";
