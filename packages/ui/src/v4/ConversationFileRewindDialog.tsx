...
import type { V4ConversationFileRewindPreviewResult } from "@wbrand/shared/wbrand-protocol-v4";
...
function formatReason(reason: string, intl: ReturnType<typeof useWBrandIntl>["intl"]) {
