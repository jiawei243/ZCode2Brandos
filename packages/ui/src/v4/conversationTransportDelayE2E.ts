import type { CommandAck } from "@wbrand/shared/wbrand-protocol-v4";
...
export async function sendWithConversationDelayE2E(
  ...
  const host =
    typeof window === "undefined"
      ? undefined
      : (window as Window & { __wbrandTransportDelayE2E?: DelayPlan });
  const plan = shouldExposeE2EStoreBridge() ? host?.__wbrandTransportDelayE2E : undefined;
