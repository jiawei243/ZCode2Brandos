...
import type { WBrandTaskClientMode } from "@wbrand/shared";
import {
  INITIAL_PANE_LAYOUT,
  MAX_WORKBENCH_PANES,
  V4_PRIMARY_PANE_ID,
...
const WORKBENCH_GROUP_STORAGE_KEY = "wbrand-v4-session-workbench-groups:v1";
...
interface WorkbenchGroupStore extends WorkbenchGroupSnapshot {
  configureClientMode: (clientMode: WBrandTaskClientMode) => void;
...
let workbenchGroupClientMode: WBrandTaskClientMode = "desktop-continuous";
