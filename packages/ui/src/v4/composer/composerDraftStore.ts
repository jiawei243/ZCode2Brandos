...
//
// 旧草稿面（wbrandSessionStore composerDraftByScopeId + chatComposerDraftStorage 写路径）
...
import { modelSelectionSchema, type ModelSelection } from "@wbrand/shared";
import { submissionModeSchema, type SubmissionMode } from "@wbrand/shared/wbrand-protocol-v4";
...
const STORAGE_KEY_PREFIX = "wbrand-v4-composer-drafts:v1:";
