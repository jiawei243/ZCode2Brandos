...
import { useToolbarConfigOptions } from "@/hooks/useWBrandConfig.js";
...
function V4ComposerModelControlsImpl({
  ...
  const thoughtOption = useMemo<WBrandConfigOption | null>(() => {
...
import { isApiKeyAccess } from "@wbrand/provider";
