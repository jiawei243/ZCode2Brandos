...
import { isWBrandAgentProvider, WBRAND_AGENT_PROVIDER, type WBrandProvider } from "@wbrand/shared";
import type { IModelSelectionService, ModelSelectionView } from "@wbrand/services";
import {
...
export function useDraftModelReadinessGate(params: {
  ...
  const enabled = sessionId === null && isWBrandAgentProvider(displayProvider);
