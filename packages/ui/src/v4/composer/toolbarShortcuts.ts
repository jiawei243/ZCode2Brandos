...
import type { ShortcutCommandId, WBrandConfigOption } from "@wbrand/shared";
import {
...
function getChatToolbarShortcutKey(
  category: WBrandConfigOption["category"],
...
export function getNextConfigSelectValue(
  option: Pick<WBrandConfigOption, "type" | "currentValue" | "options">,
): string | null {
...
interface ToolbarShortcutState {
  ...
  modelOption?: WBrandConfigOption;
  modeOption?: WBrandConfigOption;
  thoughtOption?: WBrandConfigOption;
}
