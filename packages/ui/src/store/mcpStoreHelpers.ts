...
const MCP_CONFIG_KEY = "wbrand-mcp-config";
export const MCP_DELETED_PRELOAD_KEY = "wbrand-mcp-deleted-preload";

export const DEFAULT_MCP_CONFIG: McpConfig = {
  mcp: { mcpServers: {} },
  wbrandagentmcp: { mcpServers: {}, projects: {} },
};
...
export function makeServerId(
  ...
  const sourceKey =
    source === "wbrandagentmcp" && directorySource && directorySource !== "wbrand"
...
export function buildServerList(
  ...
  existingServers: WBrandMcpServer[],
): WBrandMcpServer[] {
  ...
  function makeServer(
    ...
    source: McpSource,
    scope: WBrandMcpServer["scope"],
    enabledBySource?: boolean,
    projectPath?: string,
    file?: WBrandMcpServer["file"],
    location?: WBrandMcpServer["location"],
  ): WBrandMcpServer {
...
export function getServerPriority(server: WBrandMcpServer): number {
