...
declare global {
  interface Window {
    __wbrandModelTrajectoryStoreE2E?: typeof useModelTrajectoryStore;
  }
}
...
// 与 __wbrandSessionStoreE2E 保持同一模式，暴露 store 本身而不是另造测试专用业务实现。
if (typeof window !== "undefined") {
  window.__wbrandModelTrajectoryStoreE2E = useModelTrajectoryStore;
}
