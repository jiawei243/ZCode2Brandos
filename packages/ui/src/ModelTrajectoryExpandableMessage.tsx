...
type IntlShape = ReturnType<typeof useWBrandIntl>["intl"];
...
function compactTextPreview(message: WBrandModelTrajectoryMessage): string {
...
function firstLinePreview(message: WBrandModelTrajectoryMessage): string {
...
function messageClipboardText(message: WBrandModelTrajectoryMessage): string {
