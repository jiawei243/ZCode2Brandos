...
import { unpackWorkspaceFileEntries } from "@wbrand/shared/workspaceFileEntriesCodec";
...
import type { WorkspaceFileEntry, WBrandTaskChangeSummary, WBrandTaskMeta } from "@wbrand/shared";
import {
  Command,
  CommandDialog,
  CommandEmpty,
...
type TaskSearchResultItem = WBrandTaskMeta & {
  searchSnippet?: string;
  searchSnippets?: string[];
};
type TaskChangedFileSummary = WBrandTaskChangeSummary["files"][number];
...
function getTaskTitle(task: WBrandTaskMeta, untitledLabel: string): string {
