...
import type { Locale, LocalePreference } from "@wbrand/shared";
import { DEFAULT_LOCALE } from "@wbrand/shared";
import type { BroadcastMessage, IBroadcastService, ISettingService } from "@wbrand/services";
import {
...
const LOCALE_PREFERENCE_KEY = "wbrand-locale-preference";
 ...
 */
export function WBrandIntlProvider({
  children,
  settingService,
  broadcastService,
  initialLocale,
...
/** 获取 intl 上下文 */
export function useWBrandIntl(): IntlContextValue {
  const ctx = useContext(IntlContext);
  if (!ctx) {
    throw new Error("useWBrandIntl 必须在 WBrandIntlProvider 内使用");
  }
  return ctx;
}
