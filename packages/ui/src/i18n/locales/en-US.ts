...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like WBrand to show its work?",
  ...
  "startup.global.silent": "Starting WBrand",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen WBrand.",
  ...
  "startup.global.starting_services": "Starting WBrand",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "WBrand will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another WBrand or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen WBrand. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen WBrand to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen WBrand.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a WBrand restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into WBrand",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to WBrand and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to WBrand",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to WBrand",
  "login.description": "Connect your account to start using WBrand",
  ...
  "logout.confirm.title": "Disconnect and restart WBrand?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only WBrand Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About WBrand",
  ...
  "titleBar.menu.help.toggleWBrandStdioTap": "Capture agent stdio traffic",
  ...
  "forceUpdate.title": "Update WBrand to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart WBrand to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the WBrand CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "WBrand checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the WBrand terminal font.",
  ...
  "settings.wbrandInteractionBehavior": "Interaction behavior",
  "settings.wbrandInteractionBehaviorDescription":
    "While WBrand is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  "settings.wbrandInteractionBehavior.option.queue": "Queue",
  "settings.wbrandInteractionBehavior.option.guide": "Guide",
  ...
  "settings.dataBaseDirDescription":
    "Root directory for app data (defaults to user home directory). Existing data will be copied to the new location. The .wbrand/v2 suffix cannot be changed.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the WBrand installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching WBrand task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by WBrand",
  ...
  "resourceManager.storage.diskUsage": "WBrand uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the WBrand desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "WBrand could not verify its Windows secure import component. Reinstall or update WBrand before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, WBrand will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by WBrand Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "WBrand provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This WBrand Agent cannot refresh OAuth status. Upgrade or restart WBrand, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to WBrand to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into WBrand",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to WBrand 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by WBrand automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in WBrand.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. WBrand uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in WBrand after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "WBrand MCP",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into WBrand. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. WBrand follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into WBrand",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by WBrand Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend WBrand with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into WBrand and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. WBrand follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into WBrand",
  ...
  "settings.commands.description":
    "Manage WBrand Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.wbrandAgent": "WBrand Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into WBrand. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. WBrand follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into WBrand",
  ...
  "settings.workspaceFileSearch.description":
    "Edit .wbrandignore rules (gitignore syntax) that scope workspace file search. Takes effect on the next search after saving.",
  "settings.workspaceFileSearch.templateHint":
    ".wbrandignore does not exist yet: the content below is the initial preview (.gitignore copy + default exclusions); it is written to the workspace only after saving.",
  ...
  "settingsSync.action.finish": "Start using WBrand",
  "settingsSync.agent.wbrand": "WBrand Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current WBrand settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to WBrand",
  ...
  "onboarding.welcome.title": "Welcome to WBrand",
  "onboarding.welcome.start": "Start WBrand",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while WBrand imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "WBrand will copy {source} to {target}.\nIf the target file already exists, the WBrand default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask WBrand anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask WBrand anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, WBrand will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want WBrand to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart WBrand app and retry, or ask WBrand to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with WBrand in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for WBrand: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with WBrand in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current WBrand Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'WBrand MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No WBrand MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "WBrand",
  ...
  "feedback.submit.template.section.copyErrorHeading": "WBrand Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while WBrand is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task WBrand can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "WBrand Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "WBrand Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart WBrand",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart WBrand to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified WBrand plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "WBrand will verify the Computer Use tools against the exact session when your first session starts.",
