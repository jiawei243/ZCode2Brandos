...
const HIGHLIGHT_NAME = "wbrand-model-trajectory-find";
const ACTIVE_HIGHLIGHT_NAME = "wbrand-model-trajectory-find-active";
const STYLE_ID = "wbrand-model-trajectory-find-highlight-style";
