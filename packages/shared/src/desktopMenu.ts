...
export const desktopMenuMessageIds = {
  ...
  helpToggleWBrandStdioTap: "titleBar.menu.help.toggleWBrandStdioTap",
  helpWBrandEndpoint: "titleBar.menu.help.wbrandEndpoint",
  helpWBrandEndpointProduction: "titleBar.menu.help.wbrandEndpoint.production",
  helpWBrandEndpointTest: "titleBar.menu.help.wbrandEndpoint.test",
  helpWBrandEndpointCustom: "titleBar.menu.help.wbrandEndpoint.custom",
  helpWBrandEndpointReset: "titleBar.menu.help.wbrandEndpoint.reset",
  ...
  trayOpenWBrand: "tray.menu.openWBrand",
...
export const desktopMenuMessages: Record<Locale, DesktopMenuLocaleMessages> = {
  "zh-CN": {
    ...
    "titleBar.menu.help.wbrandEndpoint": "WBrand Endpoint",
    "titleBar.menu.help.wbrandEndpoint.production": "Production（默认）",
    "titleBar.menu.help.wbrandEndpoint.test": "Test",
    "titleBar.menu.help.wbrandEndpoint.custom": "自定义...",
    "titleBar.menu.help.wbrandEndpoint.reset": "恢复默认",
    ...
    "tray.tooltip": "WBrand",
    "tray.menu.openWBrand": "打开 WBrand",
    "tray.menu.quit": "退出",
  },
  "en-US": {
    ...
    "titleBar.menu.help.wbrandEndpoint": "WBrand Endpoint",
    "titleBar.menu.help.wbrandEndpoint.production": "Production (default)",
    "titleBar.menu.help.wbrandEndpoint.test": "Test",
    "titleBar.menu.help.wbrandEndpoint.custom": "Custom...",
    "titleBar.menu.help.wbrandEndpoint.reset": "Reset to default",
    ...
    "tray.tooltip": "WBrand",
    "tray.menu.openWBrand": "Open WBrand",
    "tray.menu.quit": "Quit",
  },
};
