export type WBrandAssistantMessagePart =
  | {
      type: "content";
      content: string;
    }
...
export function appendAssistantMessagePart(
  parts: readonly WBrandAssistantMessagePart[] | undefined,
  nextPart: WBrandAssistantMessagePart,
) {
...
export function getLatestAssistantContentPart(parts: readonly WBrandAssistantMessagePart[]) {
...
export function getLatestAssistantContentText(parts: readonly WBrandAssistantMessagePart[]) {
