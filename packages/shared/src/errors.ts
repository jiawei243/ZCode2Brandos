...
export const WBRAND_FILE_LOCK_TIMEOUT_ERROR_CODE = "WBRAND_FILE_LOCK_TIMEOUT" as const;
...
export function isWBrandFileLockTimeoutError(error: unknown): boolean {
  return normalizeUnknownError(error).code === WBRAND_FILE_LOCK_TIMEOUT_ERROR_CODE;
}
