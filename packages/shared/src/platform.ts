...
export const BROWSER_VIEW_RESTORE_BOOTSTRAP_URL = "wbrand-browser-restore://pending";
...
export const LOCAL_MEDIA_PREVIEW_SCHEME = "wbrand-media";
...
export interface WBrandStdioTapDevState {
  enabled: boolean;
  visible: boolean;
  logDir: string;
  statePath: string;
...
export const DesktopCommandIds = {
  ...
  ToggleWBrandStdioTapDevProxy: "toggleWBrandStdioTapDevProxy",
  SetWBrandEndpointProduction: "setWBrandEndpointProduction",
  SetWBrandEndpointTest: "setWBrandEndpointTest",
  SetWBrandEndpointCustom: "setWBrandEndpointCustom",
  ResetWBrandEndpoint: "resetWBrandEndpoint",
...
export interface IPlatformService {
  ...
  /** 打开 WBrand Computer Use 的完整权限引导。Desktop only。 */
  ...
  /** 注册 `wbrand://share/import?code=...` 导入意图。 */
  ...
  /** 导出日志：打包 ~/.wbrand/v2 及外部 agent 日志为 zip 并在系统文件浏览器中显示 */
