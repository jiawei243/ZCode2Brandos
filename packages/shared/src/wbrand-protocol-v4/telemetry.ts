import { z } from "zod";
import { wbrandSyntheticUserMessageSourceSchema } from "../wbrand-protocol-legacy-types.js";
...
const turnStartedFactSchema = z
  .object({
    ...
    inputSource: wbrandSyntheticUserMessageSourceSchema.optional(),
...
const toolLifecycleFactSchema = z
  .object({
    ...
    skillSource: z.enum(["agents", "wbrand", "bundled", "plugin", "remote"]).optional(),
