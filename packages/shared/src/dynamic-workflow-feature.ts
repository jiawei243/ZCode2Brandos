 ...
 */
export const WBRAND_DYNAMIC_WORKFLOW_MODE_ENV = "WBRAND_DYNAMIC_WORKFLOW_MODE";
...
export function resolveDynamicWorkflowClientConfig(input: {
  ...
  const override = normalizeDynamicWorkflowMode(input.env?.[WBRAND_DYNAMIC_WORKFLOW_MODE_ENV]);
