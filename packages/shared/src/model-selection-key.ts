...
export function buildNativeSupplierKey(wbrandProvider: WBrandProvider): string {
  return `${NATIVE_SUPPLIER_KEY_PREFIX}${wbrandProvider}`;
}
...
export function resolveSupplierKeyFromModelDisplayValue(
  ...
  return buildNativeSupplierKey(wbrandProvider);
}
