export const WBRAND_AGENT_PROVIDER_NOT_READY_CODE = "WBRAND_AGENT_PROVIDER_NOT_READY" as const;
export const WBRAND_AGENT_PROVIDER_NOT_READY_REASON = "provider_not_ready" as const;
