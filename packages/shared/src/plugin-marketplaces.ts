...
export const WBRAND_OFFICIAL_PLUGIN_MARKETPLACE_ID = "wbrand-plugins-official";
...
export const DEFAULT_ENABLED_OFFICIAL_PLUGIN_IDS: ReadonlySet<string> = new Set([
  "browser-use@wbrand-plugins-official",
  "image-search@wbrand-plugins-official",
  "documents@wbrand-plugins-official",
  "pdf@wbrand-plugins-official",
  "presentations@wbrand-plugins-official",
  "spreadsheets@wbrand-plugins-official",
  ...
  "node-repl-host@wbrand-plugins-official",
  "skill-creator@wbrand-plugins-official",
  "plugin-creator@wbrand-plugins-official",
  "wbrand-guide@wbrand-plugins-official",
...
export const DEFAULT_PLUGIN_MARKETPLACES: DefaultPluginMarketplace[] = [
  {
    ...
    source: "https://cdn-wbrand.unew.cc/wbrand/official-plugin/marketplace.json",
...
// 商店「公开」分段只有一个 WBrand 官方市场 id，内置与 CDN 不再拆分身份。
export const PUBLIC_STORE_MARKETPLACE_IDS = [WBRAND_OFFICIAL_PLUGIN_MARKETPLACE_ID] as const;
