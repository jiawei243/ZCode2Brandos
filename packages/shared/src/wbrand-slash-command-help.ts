export type BuiltinWBrandSlashCommandHelpEntry = {
...
export const BUILTIN_WBRAND_SLASH_COMMAND_HELP_ENTRIES: readonly BuiltinWBrandSlashCommandHelpEntry[] =
  [
    {
      details: [
    ...
    },
    {
      details: [
        ...
        "This command targets the workspace root, not the user default ~/.wbrand/AGENTS.md.",
      ],
      name: "init",
