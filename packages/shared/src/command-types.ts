...
export type CommandAgentSource = "wbrandAgent";
...
export type WBrandCommand = UserCommand | PluginCommand;

export function isUserCommand(command: WBrandCommand): command is UserCommand {
  return command.source === "user";
}

export function isPluginCommand(command: WBrandCommand): command is PluginCommand {
