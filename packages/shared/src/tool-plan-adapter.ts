import type { WBrandPlanStep } from "./wbrand-task-types-core.js";
...
function normalizePlanStatus(value: unknown): WBrandPlanStep["status"] | null {
...
function parsePlanStep(value: unknown, index: number): WBrandPlanStep | null {
...
function extractPlanStepsFromValue(value: unknown): WBrandPlanStep[] | null {
  ...
  const steps = collection
    ...
    .filter((step): step is WBrandPlanStep => step !== null);
