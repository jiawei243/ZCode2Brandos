import { z } from "zod";
import { OFFICIAL_MCP_TOOL_ERROR_CODES } from "@wbrand/shared";
...
export const CUA_TARGET_APP_DISPLAY_META_KEY = "wbrand.cua/target-app-display-v1" as const;
...
export const mcpToolResultDisplayPayloadSchema = z
  .object({
     ...
     * 与 code 同源：`@wbrand/shared` 的 OFFICIAL_MCP_TOOL_ERROR_CODES。
     */
    unavailable: z
