...
import { modelSelectionSchema, type ModelSelection } from "@wbrand/shared/model-selection";
import type { ModelPropertiesData, ModelOptionSpecsData } from "@wbrand/shared/model-config";

export type { ModelSelection } from "@wbrand/shared/model-selection";
...
} from "@wbrand/shared/model-config";
