...
- IAB tabs persist for the lifetime of the current WBrand process. Turn end, session end, an omitted finalize call,
...
- WBrand does not restore these tabs after the WBrand process exits.
