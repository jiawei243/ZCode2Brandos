import type { PermissionOptionsPolicy, PermissionUpdate } from "@wbrand/contracts";
import { OFFICIAL_CUA_PERMISSION_RULE_TOOL_NAME, type WBrandPermissionOption } from "@wbrand/shared";
...
export function buildProtocolPermissionOptions(
  ...
  return [
    ...
    // **没有** permissionUpdates——wire 上 wbrandPermissionUpdateSchema 是 strict，会话语义由
