...
// 1. URI ref（wbrand-artifact:// 等带 scheme:/）——经 attachment chunk transaction 寄存的内容引用：
...
import type { TurnAttachment } from "@wbrand/core";
...
async function mapAttachmentRef(app: WBrandApp, ref: AttachmentRef): Promise<TurnAttachment> {
