...
interface PersistedConversationMaterializationStore {
  getSession(sessionId: import("@wbrand/contracts").SessionId): Promise<{
    title?: string;
    revert?: {
      branchCutAfterMessageID?: import("@wbrand/contracts").MessageId;
      branchGeneration?: number;
      createdMessageID?: import("@wbrand/contracts").MessageId;
      keptMessageIDs?: import("@wbrand/contracts").MessageId[];
      targetMessageID?: import("@wbrand/contracts").MessageId;
    };
  } | null>;
  messages(input: { sessionID: import("@wbrand/contracts").SessionId }): Promise<MessageWithParts[]>;
  readTarget(input: {
    sessionID: import("@wbrand/contracts").SessionId;
...
export async function loadPersistedConversationMaterialization(input: {
  ...
  const sessionID = input.sessionId as import("@wbrand/contracts").SessionId;
