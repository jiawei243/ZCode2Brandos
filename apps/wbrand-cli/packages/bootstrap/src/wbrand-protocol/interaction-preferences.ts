import { wbrandWorkspaceUpdateInteractionPreferencesParamsSchema } from "@wbrand/shared";
...
export async function updateInteractionPreferences(
  ...
  const params = parseParams(wbrandWorkspaceUpdateInteractionPreferencesParamsSchema, rawParams);
