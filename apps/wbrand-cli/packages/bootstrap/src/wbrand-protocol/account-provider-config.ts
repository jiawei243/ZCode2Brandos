import {
  wbrandProviderUpdateAccountConfigParamsSchema,
  type WBrandProviderUpdateAccountConfigResult,
} from "@wbrand/shared";
...
export async function updateAccountProviderConfig(
  ...
  params: unknown,
): Promise<WBrandProviderUpdateAccountConfigResult> {
  const envelope = parseParams(wbrandProviderUpdateAccountConfigParamsSchema, params);
