import { wbrandWorkspaceUpdateModelIoPreferencesParamsSchema } from "@wbrand/shared";
...
export async function updateModelIoPreferences(
  ...
  const params = parseParams(wbrandWorkspaceUpdateModelIoPreferencesParamsSchema, rawParams);
