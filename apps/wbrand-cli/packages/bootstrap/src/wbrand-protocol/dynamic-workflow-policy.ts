import { wbrandWorkspaceUpdateDynamicWorkflowPolicyParamsSchema } from "@wbrand/shared";
...
export async function updateDynamicWorkflowPolicy(
  ...
  const params = parseParams(wbrandWorkspaceUpdateDynamicWorkflowPolicyParamsSchema, rawParams);
