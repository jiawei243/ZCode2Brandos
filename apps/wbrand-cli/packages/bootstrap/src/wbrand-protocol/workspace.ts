import { parseRemoteWorkspaceIdentity, type WBrandWorkspaceRef } from "@wbrand/shared";
 ...
 */
export function resolveWorkspaceRefFromId(workspaceId: string): WBrandWorkspaceRef {
