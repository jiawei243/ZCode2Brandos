...
import { getWBrandAgentModeSelectOptions, normalizeAvailableWBrandMode } from "@wbrand/shared";
import type { WBrandSessionSettingsState, WBrandSlashCommand } from "@wbrand/shared";
import type { WorkspaceConfigState } from "@wbrand/shared/wbrand-protocol-v4";
 ...
 * 创建临时 app 并被 MCP close 拖住协议通道（见 desktop warmUpWBrandAgent 的注释）。
