import { wbrandWorkspaceUpdateOffPeakToolPolicyParamsSchema } from "@wbrand/shared";
...
export async function updateOffPeakToolPolicy(
  ...
  const params = parseParams(wbrandWorkspaceUpdateOffPeakToolPolicyParamsSchema, rawParams);
