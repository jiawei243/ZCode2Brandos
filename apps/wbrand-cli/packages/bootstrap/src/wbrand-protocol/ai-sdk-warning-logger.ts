import type { LogContext, Logger } from "@wbrand/contracts";
...
export function installWBrandProtocolAiSdkWarningLogger(logger: Logger): void {
  // AI SDK 默认 warning logger 第一次会用 console.info 写 stdout；
  // app-server --stdio 的 stdout 是 WBrand Protocol NDJSON 帧通道，任何普通文本都会让宿主解析失败。
