...
import { resolveInitialModelSelection, type ModelSelectionOptions } from "@wbrand/provider";
import { resolveBashTimeoutPolicy, type AgentProfile, type AgentRuntimeConfig } from "@wbrand/core";
import { type BuiltInSubagentModelSelectionOverrides } from "@wbrand/shared";
import {
...
export function resolveAppRuntimeConfig(input: {
  ...
  const runtimeConfig: AgentRuntimeConfig = {
    ...
    // 仅接受显式传入的会话级工具面（WBrand Protocol session/create 或 CLI
