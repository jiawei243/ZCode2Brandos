import type { EmbeddedSearchBackend } from "@wbrand/contracts";
import { getRuntimeToolRuntime } from "@wbrand/shared";

const EMBEDDED_SEARCH_COMMAND_ENV = "WBRAND_EMBEDDED_SEARCH_COMMAND";
