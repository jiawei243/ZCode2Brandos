...
import { digestSummary, workspaceIdentitySummary } from "@wbrand/core";
import {
...
} from "@wbrand/shared/workspace-hook-mutation";
...
export function createWorkspaceHookReviewMutationPort(
  ...
  const editableConfigPath = resolve(workingDirectory, ".wbrand", "config.json");
