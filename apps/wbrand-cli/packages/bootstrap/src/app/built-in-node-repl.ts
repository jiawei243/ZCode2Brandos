import type { McpServerConfig, PluginLoadOutcome } from "@wbrand/contracts";
...
export function resolveBuiltInNodeReplMcpServers(input: {
  ...
  const nodeRepl = createBundledMcpRuntimeConfig({
    ...
    env: {
      ...
      ...(browserUsePackage ? { WBRAND_PLUGIN_ROOT: browserUsePackage.rootPath } : {}),
      ...(cuaPackage ? { WBRAND_CUA_PLUGIN_ROOT: cuaPackage.rootPath } : {}),
    },
