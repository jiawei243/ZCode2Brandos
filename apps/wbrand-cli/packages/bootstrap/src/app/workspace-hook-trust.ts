import { createDefaultFileWorkspaceHookTrustStore } from "@wbrand/adapters/storage";
import {
...
import { SessionEventType } from "@wbrand/contracts";
import type {
  Logger,
  SessionId,
...
import type { WorkspaceHookRuntimeRoot } from "@wbrand/shared/workspace-hook-discovery";
import {
...
export function createWorkspaceHookRuntimeSecurity(input: {
  ...
  /** 测试注入临时 HOME；生产不传，Trust store 落在真实 ~/.wbrand/security。 */
  homeDir?: string;
