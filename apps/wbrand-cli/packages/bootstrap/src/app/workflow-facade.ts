...
import { createNodeExecutionAdapter } from "@wbrand/adapters/exec";
...
import type { PrepareUserExecutionBoundary, WBrandAppOptions } from "./types.js";
...
function createWorkflowChildRuntime(
  ...
  return new AgentRuntime(
    ...
    {
      ...deps.runtimeConfig,
      agentName: options.workflowKind === "expert" ? "wbrand-expert" : "wbrand-workflow",
      mode: "yolo",
    ...
    },
    {
      ...
      ...deps.runtime.createChildClientPorts({
        ...
        agentType: options.workflowKind === "expert" ? "wbrand-expert" : "wbrand-workflow",
