...
import { SqliteSessionStore } from "@wbrand/adapters/storage";
import { resolvePath, type ConfigResult } from "@wbrand/adapters/config";
import {
...
import type { ModelSelection } from "@wbrand/provider";
...
export async function openStartupSessionStore(
  ...
  startupTimer.start("WBrand SQLite migration started", {
    context: { dbPath },
  ...
  startupTimer.mark("WBrand SQLite migration completed", {
    context: { dbPath },
