...
import type { DynamicWorkflowRunProgressPayload, Logger, SessionId } from "@wbrand/contracts";
 ...
 *
 *   WBrandApp ──1:1── AgentRuntime ──1:1── sessionId        （create-app：`new AgentRuntime(sessionId, …)`）
