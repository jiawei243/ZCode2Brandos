import { ModelErrorCode, ModelProtocolError } from "@wbrand/contracts";
import {
...
function toModelOption(provider: Provider, model: ProviderModel): WBrandModelOption {
