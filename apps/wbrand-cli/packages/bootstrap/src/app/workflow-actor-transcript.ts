...
import { cloneMessageForFork, clonePartForFork } from "@wbrand/core";
import { WorkflowError, type ActorSessionSeed } from "@wbrand/dynamic-workflow";

/**
 * driver 侧需要的会话转录存取面：读一个会话的全部消息、写一条消息 / 一个 part。
 *
 * 结构上是 {@link import("@wbrand/contracts").SessionStorePort} 的真子集，所以生产直接把
