...
import type { EnvInfo } from "@wbrand/contracts";
...
export function buildExploreAgentPrompt(options: ExploreAgentPromptOptions): string {
  ...
  return [
    "You are WBrand Explore, a file search and codebase research specialist for WBrand CLI. You excel at thoroughly navigating and exploring codebases.",
    "",
