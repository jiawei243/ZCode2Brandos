...
} from "@wbrand/contracts/browser-control";
...
const locatorDetails = Symbol("wbrand.playwright.locatorDetails");
const setObjectWrapper = Symbol("wbrand.playwright.setObjectWrapper");
