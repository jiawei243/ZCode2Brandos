...
import { ModelApiActorKind, ModelApiOperation, ModelRequestSessionType } from "@wbrand/contracts";
import { isOpenCodeGoBaseUrl } from "./opencode-session.js";
import type { ModelStatusContext } from "./runner-status.js";

const MODEL_TRACE_HEADER = "x-wbrand-trace-id";
...
const MODEL_SESSION_TYPE_HEADER = "x-wbrand-session-type";
