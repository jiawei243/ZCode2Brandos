import { resolveRuntimeWBrandEndpointOrigin } from "@wbrand/shared";
...
export function resolveOfficialCodingPlanGatewayUrl(
  ...
  const gatewayUrl = new URL(gatewayPath, resolveRuntimeWBrandEndpointOrigin(env));
