 ...
 */
const INTERACTIVE_REQUIRED_BRAND = Symbol.for("wbrand.mcp.oauth.interactiveAuthorizationRequired");
const TEMPORARY_REFRESH_FAILURE_BRAND = Symbol.for("wbrand.mcp.oauth.temporaryRefreshFailure");
