...
import type { Logger, McpOAuthConfig } from "@wbrand/contracts";
import {
...
class InteractiveAuthorizationProvider implements OAuthClientProvider {
  ...
  private readonly credentialStore: SharedWBrandCredentialStore;
  ...
  get clientMetadata(): OAuthClientMetadata {
    return {
      client_name: this.config.clientName ?? `WBrand ${this.serverName}`,
