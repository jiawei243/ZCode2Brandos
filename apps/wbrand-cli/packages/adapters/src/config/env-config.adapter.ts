// Env Config Adapter - Parse the intentionally small WBRAND_* environment surface.
...
const DEFAULT_PREFIX = "WBRAND_";

/**
 * Parse WBRAND_* environment variables into config
 */
...
export function getToolConcurrencyConfig(): { maxConcurrency: number } {
  return {
    maxConcurrency: normalizeNumber(process.env.WBRAND_MAX_TOOL_CONCURRENCY ?? "10"),
  };
}
