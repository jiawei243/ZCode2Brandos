import type { ModelUsageSummary, TodoItem, TurnId } from "@wbrand/contracts";
import { getWBrandCopy } from "@wbrand/i18n";
...
export function TuiApp({
  ...
  const initialCopy = getWBrandCopy(initialLocale).tui;
  ...
  const copy = useMemo(() => getWBrandCopy(locale), [locale]);
