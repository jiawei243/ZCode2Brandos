...
import { SessionEventType, type SessionEvent } from "@wbrand/contracts";
import type {
  WBrandSessionSubagentsResult,
  WBrandSessionRunningSubagent,
...
export type SubagentItem = WBrandSessionRunningSubagent | WBrandSessionEndedSubagent;
const EMPTY_DIRECTORY: WBrandSessionSubagentsResult = {
  revision: 0,
  childSessionIds: [],
  running: [],
  ended: { total: 0, items: [] },
