...
export const seaOfficialPluginAssetPrefix = "wbrand-official-plugins/";
...
export const officialSeaPlugins = [
  {
    ...
    marketplace: "wbrand-plugins-official",
    name: "node-repl-host",
...
function assertPluginRoot(pluginRoot, plugin) {
  if (!existsSync(join(pluginRoot, ".wbrand-plugin", "plugin.json"))) {
