...
import type { SupportedLocale, UiLocale } from "@wbrand/i18n";
import type { ModelSelection, WBrandModelOption } from "@wbrand/shared";
import type {
...
export type CommandCenterModelOption = WBrandModelOption;
...
export type CommandCenterApp = {
  ...
  readSubagents?: import("@wbrand/tui").TuiReadSubagents;
  readSubagentTranscript?: import("@wbrand/tui").TuiReadSubagentTranscript;
