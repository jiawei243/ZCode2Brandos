...
import type { runTui } from "@wbrand/tui";
...
const assetPrefix = "wbrand-tui-runtime/";
const manifestAssetKey = `${assetPrefix}manifest.json`;
const packageEntryPath = "node_modules/@wbrand/tui/dist/index.js";
...
export const loadTuiRuntime = async (): Promise<TuiRuntimeModule> => {
  ...
  if (!sea.isSea()) {
    return await import("@wbrand/tui");
  }
