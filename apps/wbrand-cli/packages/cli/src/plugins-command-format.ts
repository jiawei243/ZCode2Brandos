import { formatJson } from "@wbrand/core";
import type { GlobalOptions, JsonValue, RunContext } from "@wbrand/shared-types";
import type {
...
export function formatHumanAvailableList(plugins: readonly WBrandAvailablePluginData[]): string {
...
export function formatHumanMarketplaceList(
  marketplaces: readonly WBrandMarketplaceSummaryData[],
): string {
...
export function formatHumanPluginSet(result: SetWBrandPluginEnabledResult): string {
...
export const formatPluginSetJson = (result: SetWBrandPluginEnabledResult): string =>
  formatJson({
...
export function formatAvailablePluginJson(plugin: WBrandAvailablePluginData) {
  return {
    id: plugin.id,
...
export function formatInstalledPluginJson(plugin: WBrandInstalledPluginData) {
  return {
    enabled: plugin.enabled,
    id: plugin.id,
    marketplace: plugin.marketplace,
...
export function formatMarketplaceJson(marketplace: WBrandMarketplaceSummaryData) {
  return {
    id: marketplace.id,
