...
With no command, wbrand opens the full-screen TUI.

Commands:
  app-server Run the WBrand Protocol stdio app server
...
`,
  ...
  tui: {
    ...
    terminal: {
      ...
      starting: "Starting WBrand... Ctrl+C to exit",
    },
    transcript: {
      compact: {
