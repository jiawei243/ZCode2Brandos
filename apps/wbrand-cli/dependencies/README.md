...
This directory contains versioned third-party artifacts required by WBrand packaging.
...
pnpm --filter @wbrand/desktop prepare:native-search

# Prepare a specific target, optionally into a separate staging directory.
node scripts/prepare-native-search-tools.mjs --platform linux --arch x64 --output-dir /tmp/wbrand-native-search
